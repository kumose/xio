...
(
  "any_io_executor",
  XIO_TEST_CASE(any_io_executor_construction_test)
  XIO_TEST_CASE(any_io_executor_nothrow_construction_test)
  XIO_TEST_CASE(any_io_executor_assignment_test)
  XIO_TEST_CASE(any_io_executor_swap_test)
  XIO_TEST_CASE(any_io_executor_query_test)
  XIO_TEST_CASE(any_io_executor_execute_test)
)
