...
void connect_handler(const xio::error_code&)
{
}

void send_handler(const xio::error_code&, std::size_t)
{
}

void receive_handler(const xio::error_code&, std::size_t)
{
}
...
void test()
{
  ...
  try
  {
    ...
    xio::ip::tcp::socket tcp_socket(ioc);
