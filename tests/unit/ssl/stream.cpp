...
bool verify_callback(bool, xio::ssl::verify_context&)
{
  return false;
}

void handshake_handler(const xio::error_code&)
{
}

void buffered_handshake_handler(const xio::error_code&, std::size_t)
{
}

void shutdown_handler(const xio::error_code&)
{
}
...
void test()
{
  ...
  try
  {
    ...
    xio::ssl::context context(xio::ssl::context::sslv23);
