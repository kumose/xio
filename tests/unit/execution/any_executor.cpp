...
void any_executor_construction_test()
{
  ...
  XIO_CHECK(ex_two_props_1.target<void>() == 0);
  XIO_CHECK(ex_two_props_1 == null_ptr);

  ex_two_props_t ex_two_props_2(null_ptr);

  XIO_CHECK(ex_two_props_2.target<void>() == 0);
  XIO_CHECK(ex_two_props_2 == null_ptr);
  XIO_CHECK(ex_two_props_2 == ex_two_props_1);

  ex_two_props_t ex_two_props_3(pool.executor());

  XIO_CHECK(ex_two_props_3.target<void>() != 0);
  XIO_CHECK(ex_two_props_3 != null_ptr);
  XIO_CHECK(ex_two_props_3 != ex_two_props_1);

  ex_two_props_t ex_two_props_4(ex_two_props_1);

  XIO_CHECK(ex_two_props_4.target<void>() == 0);
  XIO_CHECK(ex_two_props_4 == null_ptr);
  XIO_CHECK(ex_two_props_4 == ex_two_props_1);

  ex_two_props_t ex_two_props_5(ex_two_props_3);

  XIO_CHECK(ex_two_props_5.target<void>() != 0);
  XIO_CHECK(ex_two_props_5 != null_ptr);
  XIO_CHECK(ex_two_props_5 == ex_two_props_3);

  ex_two_props_t ex_two_props_6 = fat_executor(1);

  XIO_CHECK(ex_two_props_6.target<void>() != 0);
  XIO_CHECK(ex_two_props_6 != null_ptr);
  XIO_CHECK(ex_two_props_6 != ex_two_props_1);

  ex_two_props_t ex_two_props_7 = fat_executor(1);

  XIO_CHECK(ex_two_props_7.target<void>() != 0);
  XIO_CHECK(ex_two_props_7 != null_ptr);
  XIO_CHECK(ex_two_props_7 != ex_two_props_1);
  XIO_CHECK(ex_two_props_7 == ex_two_props_6);

  ex_two_props_t ex_two_props_8 = fat_executor(2);

  XIO_CHECK(ex_two_props_8.target<void>() != 0);
  XIO_CHECK(ex_two_props_8 != null_ptr);
  XIO_CHECK(ex_two_props_8 != ex_two_props_1);
  XIO_CHECK(ex_two_props_8 != ex_two_props_6);
  XIO_CHECK(ex_two_props_8 != ex_two_props_7);

  ex_two_props_t ex_two_props_9(ex_two_props_6);

  XIO_CHECK(ex_two_props_9.target<void>() != 0);
  XIO_CHECK(ex_two_props_9 != null_ptr);
  XIO_CHECK(ex_two_props_9 != ex_two_props_1);
  XIO_CHECK(ex_two_props_9 == ex_two_props_6);
  XIO_CHECK(ex_two_props_9 == ex_two_props_7);
  XIO_CHECK(ex_two_props_9 != ex_two_props_8);

  ex_two_props_t ex_two_props_10(std::move(ex_two_props_1));

  XIO_CHECK(ex_two_props_10.target<void>() == 0);
  XIO_CHECK(ex_two_props_10 == null_ptr);
  XIO_CHECK(ex_two_props_1.target<void>() == 0);
  XIO_CHECK(ex_two_props_1 == null_ptr);

  ex_two_props_t ex_two_props_11(std::move(ex_two_props_3));

  XIO_CHECK(ex_two_props_11.target<void>() != 0);
  XIO_CHECK(ex_two_props_11 != null_ptr);
  XIO_CHECK(ex_two_props_3.target<void>() == 0);
  XIO_CHECK(ex_two_props_3 == null_ptr);
  XIO_CHECK(ex_two_props_11 == ex_two_props_5);

  ex_two_props_t ex_two_props_12(std::move(ex_two_props_7));

  XIO_CHECK(ex_two_props_12.target<void>() != 0);
  XIO_CHECK(ex_two_props_12 != null_ptr);
  XIO_CHECK(ex_two_props_7.target<void>() == 0);
  XIO_CHECK(ex_two_props_7 == null_ptr);
  XIO_CHECK(ex_two_props_12 == ex_two_props_6);
  XIO_CHECK(ex_two_props_12 != ex_two_props_8);

  ex_one_prop_t ex_one_prop_1;

  XIO_CHECK(ex_one_prop_1.target<void>() == 0);
  XIO_CHECK(ex_one_prop_1 == null_ptr);

  ex_one_prop_t ex_one_prop_2(null_ptr);

  XIO_CHECK(ex_one_prop_2.target<void>() == 0);
  XIO_CHECK(ex_one_prop_2 == null_ptr);
  XIO_CHECK(ex_one_prop_2 == ex_one_prop_1);

  ex_one_prop_t ex_one_prop_3(pool.executor());

  XIO_CHECK(ex_one_prop_3.target<void>() != 0);
  XIO_CHECK(ex_one_prop_3 != null_ptr);
  XIO_CHECK(ex_one_prop_3 != ex_one_prop_1);

  ex_one_prop_t ex_one_prop_4(ex_one_prop_1);

  XIO_CHECK(ex_one_prop_4.target<void>() == 0);
  XIO_CHECK(ex_one_prop_4 == null_ptr);
  XIO_CHECK(ex_one_prop_4 == ex_one_prop_1);

  ex_one_prop_t ex_one_prop_5(ex_one_prop_3);

  XIO_CHECK(ex_one_prop_5.target<void>() != 0);
  XIO_CHECK(ex_one_prop_5 != null_ptr);
  XIO_CHECK(ex_one_prop_5 == ex_one_prop_3);

  ex_one_prop_t ex_one_prop_6 = fat_executor(1);

  XIO_CHECK(ex_one_prop_6.target<void>() != 0);
  XIO_CHECK(ex_one_prop_6 != null_ptr);
  XIO_CHECK(ex_one_prop_6 != ex_one_prop_1);

  ex_one_prop_t ex_one_prop_7 = fat_executor(1);

  XIO_CHECK(ex_one_prop_7.target<void>() != 0);
  XIO_CHECK(ex_one_prop_7 != null_ptr);
  XIO_CHECK(ex_one_prop_7 != ex_one_prop_1);
  XIO_CHECK(ex_one_prop_7 == ex_one_prop_6);

  ex_one_prop_t ex_one_prop_8 = fat_executor(2);

  XIO_CHECK(ex_one_prop_8.target<void>() != 0);
  XIO_CHECK(ex_one_prop_8 != null_ptr);
  XIO_CHECK(ex_one_prop_8 != ex_one_prop_1);
  XIO_CHECK(ex_one_prop_8 != ex_one_prop_6);
  XIO_CHECK(ex_one_prop_8 != ex_one_prop_7);

  ex_one_prop_t ex_one_prop_9(ex_one_prop_6);

  XIO_CHECK(ex_one_prop_9.target<void>() != 0);
  XIO_CHECK(ex_one_prop_9 != null_ptr);
  XIO_CHECK(ex_one_prop_9 != ex_one_prop_1);
  XIO_CHECK(ex_one_prop_9 == ex_one_prop_6);
  XIO_CHECK(ex_one_prop_9 == ex_one_prop_7);
  XIO_CHECK(ex_one_prop_9 != ex_one_prop_8);

  ex_one_prop_t ex_one_prop_10(std::move(ex_one_prop_1));

  XIO_CHECK(ex_one_prop_10.target<void>() == 0);
  XIO_CHECK(ex_one_prop_10 == null_ptr);
  XIO_CHECK(ex_one_prop_1.target<void>() == 0);
  XIO_CHECK(ex_one_prop_1 == null_ptr);

  ex_one_prop_t ex_one_prop_11(std::move(ex_one_prop_3));

  XIO_CHECK(ex_one_prop_11.target<void>() != 0);
  XIO_CHECK(ex_one_prop_11 != null_ptr);
  XIO_CHECK(ex_one_prop_3.target<void>() == 0);
  XIO_CHECK(ex_one_prop_3 == null_ptr);
  XIO_CHECK(ex_one_prop_11 == ex_one_prop_5);

  ex_one_prop_t ex_one_prop_12(std::move(ex_one_prop_7));

  XIO_CHECK(ex_one_prop_12.target<void>() != 0);
  XIO_CHECK(ex_one_prop_12 != null_ptr);
  XIO_CHECK(ex_one_prop_7.target<void>() == 0);
  XIO_CHECK(ex_one_prop_7 == null_ptr);
  XIO_CHECK(ex_one_prop_12 == ex_one_prop_6);
  XIO_CHECK(ex_one_prop_12 != ex_one_prop_8);

  ex_one_prop_t ex_one_prop_13(ex_two_props_1);

  XIO_CHECK(ex_one_prop_13.target<void>() == 0);
  XIO_CHECK(ex_one_prop_13 == null_ptr);

  ex_one_prop_t ex_one_prop_14(ex_two_props_5);

  XIO_CHECK(ex_one_prop_14.target<void>() != 0);
  XIO_CHECK(ex_one_prop_14 != null_ptr);

  ex_one_prop_t ex_one_prop_15(ex_two_props_9);

  XIO_CHECK(ex_one_prop_15.target<void>() != 0);
  XIO_CHECK(ex_one_prop_15 != null_ptr);

  ex_no_props_t ex_no_props_1;

  XIO_CHECK(ex_no_props_1.target<void>() == 0);
  XIO_CHECK(ex_no_props_1 == null_ptr);

  ex_no_props_t ex_no_props_2(null_ptr);

  XIO_CHECK(ex_no_props_2.target<void>() == 0);
  XIO_CHECK(ex_no_props_2 == null_ptr);
  XIO_CHECK(ex_no_props_2 == ex_no_props_1);

  ex_no_props_t ex_no_props_3(pool.executor());

  XIO_CHECK(ex_no_props_3.target<void>() != 0);
  XIO_CHECK(ex_no_props_3 != null_ptr);
  XIO_CHECK(ex_no_props_3 != ex_no_props_1);

  ex_no_props_t ex_no_props_4(ex_no_props_1);

  XIO_CHECK(ex_no_props_4.target<void>() == 0);
  XIO_CHECK(ex_no_props_4 == null_ptr);
  XIO_CHECK(ex_no_props_4 == ex_no_props_1);

  ex_no_props_t ex_no_props_5(ex_no_props_3);

  XIO_CHECK(ex_no_props_5.target<void>() != 0);
  XIO_CHECK(ex_no_props_5 != null_ptr);
  XIO_CHECK(ex_no_props_5 == ex_no_props_3);

  ex_no_props_t ex_no_props_6 = fat_executor(1);

  XIO_CHECK(ex_no_props_6.target<void>() != 0);
  XIO_CHECK(ex_no_props_6 != null_ptr);
  XIO_CHECK(ex_no_props_6 != ex_no_props_1);

  ex_no_props_t ex_no_props_7 = fat_executor(1);

  XIO_CHECK(ex_no_props_7.target<void>() != 0);
  XIO_CHECK(ex_no_props_7 != null_ptr);
  XIO_CHECK(ex_no_props_7 != ex_no_props_1);
  XIO_CHECK(ex_no_props_7 == ex_no_props_6);

  ex_no_props_t ex_no_props_8 = fat_executor(2);

  XIO_CHECK(ex_no_props_8.target<void>() != 0);
  XIO_CHECK(ex_no_props_8 != null_ptr);
  XIO_CHECK(ex_no_props_8 != ex_no_props_1);
  XIO_CHECK(ex_no_props_8 != ex_no_props_6);
  XIO_CHECK(ex_no_props_8 != ex_no_props_7);

  ex_no_props_t ex_no_props_9(ex_no_props_6);

  XIO_CHECK(ex_no_props_9.target<void>() != 0);
  XIO_CHECK(ex_no_props_9 != null_ptr);
  XIO_CHECK(ex_no_props_9 != ex_no_props_1);
  XIO_CHECK(ex_no_props_9 == ex_no_props_6);
  XIO_CHECK(ex_no_props_9 == ex_no_props_7);
  XIO_CHECK(ex_no_props_9 != ex_no_props_8);

  ex_no_props_t ex_no_props_10(std::move(ex_no_props_1));

  XIO_CHECK(ex_no_props_10.target<void>() == 0);
  XIO_CHECK(ex_no_props_10 == null_ptr);
  XIO_CHECK(ex_no_props_1.target<void>() == 0);
  XIO_CHECK(ex_no_props_1 == null_ptr);

  ex_no_props_t ex_no_props_11(std::move(ex_no_props_3));

  XIO_CHECK(ex_no_props_11.target<void>() != 0);
  XIO_CHECK(ex_no_props_11 != null_ptr);
  XIO_CHECK(ex_no_props_3.target<void>() == 0);
  XIO_CHECK(ex_no_props_3 == null_ptr);
  XIO_CHECK(ex_no_props_11 == ex_no_props_5);

  ex_no_props_t ex_no_props_12(std::move(ex_no_props_7));

  XIO_CHECK(ex_no_props_12.target<void>() != 0);
  XIO_CHECK(ex_no_props_12 != null_ptr);
  XIO_CHECK(ex_no_props_7.target<void>() == 0);
  XIO_CHECK(ex_no_props_7 == null_ptr);
  XIO_CHECK(ex_no_props_12 == ex_no_props_6);
  XIO_CHECK(ex_no_props_12 != ex_no_props_8);

  ex_no_props_t ex_no_props_13(ex_two_props_1);

  XIO_CHECK(ex_no_props_13.target<void>() == 0);
  XIO_CHECK(ex_no_props_13 == null_ptr);

  ex_no_props_t ex_no_props_14(ex_two_props_5);

  XIO_CHECK(ex_no_props_14.target<void>() != 0);
  XIO_CHECK(ex_no_props_14 != null_ptr);

  ex_no_props_t ex_no_props_15(ex_two_props_9);

  XIO_CHECK(ex_no_props_15.target<void>() != 0);
  XIO_CHECK(ex_no_props_15 != null_ptr);

  ex_no_props_t ex_no_props_16(ex_one_prop_1);

  XIO_CHECK(ex_no_props_16.target<void>() == 0);
  XIO_CHECK(ex_no_props_16 == null_ptr);

  ex_no_props_t ex_no_props_17(ex_one_prop_5);

  XIO_CHECK(ex_no_props_17.target<void>() != 0);
  XIO_CHECK(ex_no_props_17 != null_ptr);

  ex_no_props_t ex_no_props_18(ex_one_prop_9);

  XIO_CHECK(ex_no_props_18.target<void>() != 0);
  XIO_CHECK(ex_no_props_18 != null_ptr);
}
...
void any_executor_nothrow_construction_test()
{
  ...
  XIO_CHECK(ex_two_props_13.target<void>() == 0);
  XIO_CHECK(ex_two_props_13 == null_ptr);
  XIO_CHECK(ex_two_props_13 == ex_two_props_1);
  ...
  XIO_CHECK(ex_one_prop_16.target<void>() == 0);
  XIO_CHECK(ex_one_prop_16 == null_ptr);
  XIO_CHECK(ex_one_prop_16 == ex_one_prop_1);
  ...
  XIO_CHECK(ex_no_props_19.target<void>() == 0);
  XIO_CHECK(ex_no_props_19 == null_ptr);
  XIO_CHECK(ex_no_props_19 == ex_no_props_1);
}
...
void any_executor_assignment_test()
{
  ...
  XIO_CHECK(ex_two_props_4.target<void>() != 0);
  XIO_CHECK(ex_two_props_4 == ex_two_props_3);
  ...
  XIO_CHECK(ex_two_props_5.target<void>() != 0);
  XIO_CHECK(ex_two_props_5 != null_ptr);
  XIO_CHECK(ex_two_props_5 != ex_two_props_1);
  ...
  XIO_CHECK(ex_two_props_6 != null_ptr);
  XIO_CHECK(ex_two_props_6 != ex_two_props_1);
  XIO_CHECK(ex_two_props_6 == ex_two_props_5);
  ...
  XIO_CHECK(ex_two_props_7 != null_ptr);
  XIO_CHECK(ex_two_props_7 != ex_two_props_1);
  XIO_CHECK(ex_two_props_7 == ex_two_props_5);
  XIO_CHECK(ex_two_props_7 != ex_two_props_6);
  ...
  XIO_CHECK(ex_two_props_8.target<void>() != 0);
  XIO_CHECK(ex_two_props_3.target<void>() == 0);
  XIO_CHECK(ex_two_props_8 == ex_two_props_4);
  ...
  XIO_CHECK(ex_one_prop_4.target<void>() != 0);
  XIO_CHECK(ex_one_prop_4 == ex_one_prop_3);
  ...
  XIO_CHECK(ex_one_prop_5.target<void>() != 0);
  XIO_CHECK(ex_one_prop_5 != null_ptr);
  XIO_CHECK(ex_one_prop_5 != ex_one_prop_1);
  ...
  XIO_CHECK(ex_one_prop_6 != null_ptr);
  XIO_CHECK(ex_one_prop_6 != ex_one_prop_1);
  XIO_CHECK(ex_one_prop_6 == ex_one_prop_5);
  ...
  XIO_CHECK(ex_one_prop_7 != null_ptr);
  XIO_CHECK(ex_one_prop_7 != ex_one_prop_1);
  XIO_CHECK(ex_one_prop_7 == ex_one_prop_5);
  XIO_CHECK(ex_one_prop_7 != ex_one_prop_6);
  ...
  XIO_CHECK(ex_one_prop_8.target<void>() != 0);
  XIO_CHECK(ex_one_prop_3.target<void>() == 0);
  XIO_CHECK(ex_one_prop_8 == ex_one_prop_4);
  ...
  XIO_CHECK(ex_no_props_4.target<void>() != 0);
  XIO_CHECK(ex_no_props_4 == ex_no_props_3);
  ...
  XIO_CHECK(ex_no_props_5.target<void>() != 0);
  XIO_CHECK(ex_no_props_5 != null_ptr);
  XIO_CHECK(ex_no_props_5 != ex_no_props_1);
  ...
  XIO_CHECK(ex_no_props_6 != null_ptr);
  XIO_CHECK(ex_no_props_6 != ex_no_props_1);
  XIO_CHECK(ex_no_props_6 == ex_no_props_5);
  ...
  XIO_CHECK(ex_no_props_7 != null_ptr);
  XIO_CHECK(ex_no_props_7 != ex_no_props_1);
  XIO_CHECK(ex_no_props_7 == ex_no_props_5);
  XIO_CHECK(ex_no_props_7 != ex_no_props_6);
  ...
  XIO_CHECK(ex_no_props_8.target<void>() != 0);
  XIO_CHECK(ex_no_props_3.target<void>() == 0);
  XIO_CHECK(ex_no_props_8 == ex_no_props_4);
...
void any_executor_swap_test()
{
  ...
  XIO_CHECK(ex_no_props_3 == ex_no_props_1);
  XIO_CHECK(ex_no_props_4 == ex_no_props_2);

  ex_no_props_3.swap(ex_no_props_4);

  XIO_CHECK(ex_no_props_3 == ex_no_props_2);
  XIO_CHECK(ex_no_props_4 == ex_no_props_1);
  ...
  XIO_CHECK(ex_one_prop_3 == ex_one_prop_1);
  XIO_CHECK(ex_one_prop_4 == ex_one_prop_2);

  ex_one_prop_3.swap(ex_one_prop_4);

  XIO_CHECK(ex_one_prop_3 == ex_one_prop_2);
  XIO_CHECK(ex_one_prop_4 == ex_one_prop_1);
  ...
  XIO_CHECK(ex_two_props_3 == ex_two_props_1);
  XIO_CHECK(ex_two_props_4 == ex_two_props_2);

  ex_two_props_3.swap(ex_two_props_4);

  XIO_CHECK(ex_two_props_3 == ex_two_props_2);
  XIO_CHECK(ex_two_props_4 == ex_two_props_1);
...
void any_executor_query_test()
{
  ...
  XIO_CHECK(
      xio::query(ex, xio::execution::mapping)
        == xio::execution::mapping.thread);

  XIO_CHECK(
      xio::query(ex, xio::execution::occupancy)
        == 1);
}
...
void any_executor_execute_test()
{
  ...
  xio::require(ex, xio::execution::blocking.possibly).execute(
...
(
  "any_executor",
  XIO_TEST_CASE(any_executor_construction_test)
  XIO_TEST_CASE(any_executor_nothrow_construction_test)
  XIO_TEST_CASE(any_executor_assignment_test)
  XIO_TEST_CASE(any_executor_swap_test)
  XIO_TEST_CASE(any_executor_query_test)
  XIO_TEST_CASE(any_executor_execute_test)
)
