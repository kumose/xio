...
namespace ip_tcp_socket_runtime {
    ...
    void handle_read_noop(const xio::error_code &err,
    ...
    void test() {
        ...
        xio::async_read(server_side_socket,
                        xio::buffer(read_buffer),
...
namespace ip_tcp_acceptor_compile {
    ...
    struct move_accept_handler {
        ...
        void operator()(
            const xio::error_code &, xio::ip::tcp::socket) {
        }
    ...
    struct move_accept_ioc_handler {
        ...
        void operator()(const xio::error_code &,
                        xio::basic_stream_socket<xio::ip::tcp,
                            xio::io_context::executor_type>) {
        }
    ...
    void test() {
        ...
        try {
            ...
            xio::basic_stream_socket<ip::tcp,
...
namespace ip_tcp_resolver_compile {
    struct resolve_handler {
        ...
        void operator()(const xio::error_code &,
                        xio::ip::tcp::resolver::results_type) {
        }
