...
int main()
{
  ...
  constexpr object<1> o9 = xio::require(object<1>(), prop<1>());
  constexpr object<1> o10 = xio::require(object<1>(), prop<1>(), prop<1>());
  constexpr object<1> o11 = xio::require(object<1>(), prop<1>(), prop<1>(), prop<1>());
  (void)o9;
  (void)o10;
  (void)o11;
}
