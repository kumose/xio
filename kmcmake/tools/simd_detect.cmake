...
macro(check_x86_simd_flags)
    ...
    # avx512
    if (WIN32)
        set(_KMCMAKE_AVX512_FLAGS "${AVX512_FLAG}")
    else ()
        set(_KMCMAKE_AVX512_FLAGS "${AVX512F_FLAG}")
    endif ()
    kmcmake_detect_simd("${AVX512_DEFAULT_CODE}" "${_KMCMAKE_AVX512_FLAGS}" KMCMAKE_X86_AVX512F)
    if (KMCMAKE_X86_AVX512F)
        list(APPEND KMCMAKE_X86_SUPPORT_FLAGS "${_KMCMAKE_AVX512_FLAGS}")
    endif ()
endmacro()
