...
private:
  ...
  void handle_connect(const std::error_code& err)
  {
    if (!err)
    {
      ...
      xio::async_write(socket_, request_,
  ...
  void handle_write_request(const std::error_code& err)
  {
    if (!err)
    {
      ...
      xio::async_read_until(socket_, response_, "\r\n",
  ...
  void handle_read_headers(const std::error_code& err)
  {
    if (!err)
    {
      ...
      xio::async_read(socket_, response_,
  ...
  tcp::socket socket_;
  xio::streambuf request_;
  xio::streambuf response_;
};
