...
struct custom_tracking
{
  ...
  static void creation(xio::execution_context& /*ctx*/,
  ...
  {
    static XIO_THREAD_KEYWORD completion* current = nullptr;
    return &current;
  }

  // Record an operation that is not directly associated with a handler.
  static void operation(xio::execution_context& /*ctx*/,
  ...
  static void reactor_registration(xio::execution_context& context,
  ...
  static void reactor_deregistration(xio::execution_context& context,
      uintmax_t native_handle, uintmax_t registration)
  {
  ...
  static void reactor_events(xio::execution_context& context,
      uintmax_t registration, unsigned events)
  {
    std::printf(
        "Reactor readiness for registration = %" PRIuMAX ", events =%s%s%s\n",
        registration,
        (events & XIO_HANDLER_REACTOR_READ_EVENT) ? " read" : "",
        (events & XIO_HANDLER_REACTOR_WRITE_EVENT) ? " write" : "",
        (events & XIO_HANDLER_REACTOR_ERROR_EVENT) ? " error" : "");
  }
