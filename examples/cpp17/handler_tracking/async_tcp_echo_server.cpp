...
// Define a helper macro to invoke XIO_HANDLER_LOCATION with the current
...
#define HANDLER_LOCATION \
  XIO_HANDLER_LOCATION((__FILE__, __LINE__, __func__))
...
private:
  void do_read()
  {
    ...
    socket_.async_read_some(xio::buffer(data_, max_length),
