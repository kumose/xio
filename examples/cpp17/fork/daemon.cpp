...
{
public:
  udp_daytime_server(xio::io_context& io_context)
    ...
    socket_.async_receive_from(
        ...
        [this](std::error_code ec, std::size_t /*n*/)
        {
          if (!ec)
          {
            ...
            socket_.send_to(xio::buffer(message),
...
int main()
{
  try
  {
    ...
    io_context.notify_fork(xio::io_context::fork_prepare);
    ...
    if (pid_t pid = fork())
    {
      if (pid > 0)
      {
        ...
        //
        //   io_context.notify_fork(xio::io_context::fork_parent);
        //
    ...
    io_context.notify_fork(xio::io_context::fork_child);
