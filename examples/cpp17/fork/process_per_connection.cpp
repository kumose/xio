    ...
    acceptor_.async_accept(
        [this](std::error_code ec, tcp::socket new_socket)
        {
          if (!ec)
          {
            ...
            io_context_.notify_fork(xio::io_context::fork_prepare);
            ...
            if (fork() == 0)
            {
              ...
              // the new process.
              io_context_.notify_fork(xio::io_context::fork_child);
            ...
            else
            {
              ...
              io_context_.notify_fork(xio::io_context::fork_parent);
