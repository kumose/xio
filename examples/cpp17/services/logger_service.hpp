...
class logger_service
  : public xio::execution_context::service
{
public:
  ...
  logger_service(xio::execution_context& context)
    : xio::execution_context::service(context),
      work_io_context_(),
      work_(xio::make_work_guard(work_io_context_)),
...
private:
  ...
  xio::io_context work_io_context_;
  ...
  xio::executor_work_guard<
      xio::io_context::executor_type> work_;
