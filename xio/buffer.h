...
/// MutableBufferSequence concepts to represent a null buffer sequence.
    ...
    /** @defgroup buffer_sequence_begin xio::buffer_sequence_begin
 *
 * @brief The xio::buffer_sequence_begin function returns an iterator
 ...
 */
    ...
    /** @defgroup buffer_sequence_end xio::buffer_sequence_end
 *
 * @brief The xio::buffer_sequence_end function returns an iterator
 ...
 * auto i = xio::buffer_sequence_begin(buffers);
 * auto end = xio::buffer_sequence_end(buffers);
 * for (; i != end; ++i)
 * {
 *   const_buffer b(*i);
 *   total_size += b.size();
 ...
 */
    ...
    inline std::size_t buffer_size(const BufferSequence &b) noexcept {
        return detail::buffer_size(
            ...
            xio::buffer_sequence_begin(b),
            xio::buffer_sequence_end(b));
    }
 ...
 *
 * @brief The xio::buffer function is used to create a buffer object to
 ...
 * specified size:
 *
 * @code sock.send(xio::buffer(data, size)); @endcode
 *
 * In the above example, the return value of xio::buffer meets the
 ...
 *
 * @code char d1[128];
 * size_t bytes_transferred = sock.receive(xio::buffer(d1));
 *
 * std::vector<char> d2(128);
 * bytes_transferred = sock.receive(xio::buffer(d2));
 *
 * std::array<char, 128> d3;
 * bytes_transferred = sock.receive(xio::buffer(d3));
 *
 * boost::array<char, 128> d4;
 * bytes_transferred = sock.receive(xio::buffer(d4)); @endcode
 *
 ...
 *
 * vector<unsigned char> data(xio::buffer_size(buffers));
 * xio::buffer_copy(xio::buffer(data), buffers); @endcode
 *
 ...
 *
 * For the xio::buffer overloads that accept an argument of type
 ...
 *
 * @code b1 = xio::buffer(a); @endcode
 *
 * represents the entire array, <tt>{ 'a', 'b', 'c', 'd', 'e' }</tt>. An
 * optional second argument to the xio::buffer function may be used to
 * limit the size, in bytes, of the buffer:
 *
 * @code b2 = xio::buffer(a, 3); @endcode
 *
 ...
 *
 * @code b4 = xio::buffer(b1 + 1, 3); @endcode
 *
 ...
 * bufs2.push_back(xio::buffer(d1));
 * bufs2.push_back(xio::buffer(d2));
 * bufs2.push_back(xio::buffer(d3));
 * bytes_transferred = sock.send(bufs2); @endcode
 *
 * @par Buffer Literals
 *
 * The `_buf` literal suffix, defined in namespace
 * <tt>xio::buffer_literals</tt>, may be used to create @c const_buffer
 ...
 *
 * xio::const_buffer b1 = "hello"_buf;
 * xio::const_buffer b2 = 0xdeadbeef_buf;
 * xio::const_buffer b3 = 0x0123456789abcdef0123456789abcdef_buf;
 * xio::const_buffer b4 = 0b1010101011001100_buf; @endcode
 *
 ...
 */
   ...
   */
        mutable_buffers_type data(std::size_t pos, std::size_t n) noexcept {
            return mutable_buffers_type(xio::buffer(
   ...
   */
        const_buffers_type data(std::size_t pos,
            ...
            return const_buffers_type(xio::buffer(
                xio::buffer(string_, max_size_) + pos, n));
        }
   ...
   */
        mutable_buffers_type prepare(std::size_t n) {
            ...
            return xio::buffer(xio::buffer(string_) + size_, n);
        }
 ...
 */
   ...
   */
        mutable_buffers_type prepare(std::size_t n) {
            ...
            return xio::buffer(xio::buffer(vector_) + size_, n);
        }
   ...
   */
    ...
    /** @defgroup dynamic_buffer xio::dynamic_buffer
 *
 * @brief The xio::dynamic_buffer function is used to create a
 ...
 */
    ...
    /** @defgroup buffer_copy xio::buffer_copy
 *
 * @brief The xio::buffer_copy function is used to copy bytes from a
    ...
    namespace detail {
        ...
        inline std::size_t buffer_copy(one_buffer, one_buffer,
            ...
            return (buffer_copy_1)(*target_begin,
                                   xio::buffer(*source_begin, max_bytes_to_copy));
        }
        ...
        std::size_t buffer_copy(one_buffer, multiple_buffers,
            ...
            for (mutable_buffer target_buffer(
                     xio::buffer(*target_begin, max_bytes_to_copy));
        ...
        std::size_t buffer_copy(multiple_buffers, multiple_buffers,
            ...
            while (total_bytes_copied != max_bytes_to_copy
                ...
                std::size_t bytes_copied = (buffer_copy_1)(
                    target_buffer, xio::buffer(source_buffer,
 ...
 */
    ...
    inline std::size_t buffer_copy(const MutableBufferSequence &target,
        ...
        return detail::buffer_copy(
            ...
            xio::buffer_sequence_begin(target),
            xio::buffer_sequence_end(target),
            xio::buffer_sequence_begin(source),
            xio::buffer_sequence_end(source));
    }
 ...
 */
    ...
    inline std::size_t buffer_copy(const MutableBufferSequence &target,
        ...
        return detail::buffer_copy(
            ...
            xio::buffer_sequence_end(target),
            xio::buffer_sequence_begin(source),
            xio::buffer_sequence_end(source), max_bytes_to_copy);
    }
...
#include <xio/detail/is_buffer_sequence.h>
#include <xio/detail/push_options.h>
