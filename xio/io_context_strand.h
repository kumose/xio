 ...
 */
   ...
   */
        explicit strand(xio::io_context &io_context)
            : service_(xio::use_service<
                xio::detail::strand_service>(io_context)) {
   ...
   */
        ...
        xio::io_context &context() const noexcept {
   ...
   */
    ...
    private:
        xio::detail::strand_service &service_;
