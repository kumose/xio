...
namespace xio {
    ...
    namespace ip {
        ...
        /**
 * The xio::ip::address_v4 class provides the ability to use and
 ...
 */
   ...
   */
        ...
        private:
            ...
            xio::detail::in4_addr_type addr_;
        };
...
namespace std {
    template<>
    struct hash<xio::ip::address_v4> {
        std::size_t operator()(const xio::ip::address_v4 &addr)
        const noexcept {
