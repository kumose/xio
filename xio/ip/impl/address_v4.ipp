...
namespace xio {
    ...
    namespace ip {
        ...
        address_v4::address_v4(address_v4::uint_type addr) {
            ...
            addr_.s_addr = xio::detail::socket_ops::host_to_network_long(
                static_cast<xio::detail::u_long_type>(addr));
        }
        ...
        address_v4::uint_type address_v4::to_uint() const noexcept {
            return xio::detail::socket_ops::network_to_host_long(addr_.s_addr);
        }
