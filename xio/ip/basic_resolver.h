 ...
 */
   ...
   * will be invoked with the xio::error::operation_aborted error code.
   */
            void cancel() {
   ...
   */
            results_type resolve(ASIO_STRING_VIEW_PARAM host,
                ...
                xio::detail::throw_error(ec, "resolve");
                return r;
            }
   ...
   * function is guaranteed to return a non-empty range.
   */
            results_type resolve(const endpoint_type &e, xio::error_code &ec) {
        ...
        private:
            ...
            public:
                ...
                void operator()(ResolveHandler &&handler,
                    ...
                    xio::detail::non_const_lvalue<ResolveHandler> handler2(handler);
...
# else
            xio::detail::io_object_impl<
                xio::detail::resolver_service<InternetProtocol>,
                Executor> impl_;
# endif
        };
    } // namespace ip
