...
#ifndef XIO_IP_BASIC_RESOLVER_ENTRY_HPP
#define XIO_IP_BASIC_RESOLVER_ENTRY_HPP
...
namespace xio {
    ...
    namespace ip {
        ...
        /**
 * The xio::ip::basic_resolver_entry class template describes an entry
...
#endif // XIO_IP_BASIC_RESOLVER_ENTRY_HPP
