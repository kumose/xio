 ...
 *
 * Most applications will use one of the xio::steady_timer,
 * xio::system_timer or xio::high_resolution_timer typedefs.
 *
 ...
 * xio::steady_timer timer(my_context);
 *
 ...
 * @endcode
 *
 * @li The xio::basic_waitable_timer::expires_after() function
 ...
 */
   ...
   */
        basic_waitable_timer(const executor_type &ex, const duration &expiry_time)
            ...
            xio::detail::throw_error(ec, "expires_after");
        }
