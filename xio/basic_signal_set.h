...
#include <xio/detail/signal_set_service.h>
 ...
 * xio::signal_set signals(my_context, SIGINT, SIGTERM);
 *
 ...
 */
   ...
   * @code xio::signal_set signals(ex);
   ...
   *
   * @note This constructor is equivalent to performing:
   * @code xio::signal_set signals(context);
   * signals.add(signal_number_1); @endcode
   */
        template<typename ExecutionContext>
   ...
   */
        void remove(int signal_number) {
            ...
            xio::detail::throw_error(ec, "remove");
        }
   ...
   */
        void clear() {
            ...
            xio::detail::throw_error(ec, "clear");
        }
   ...
   * operation will be invoked with the xio::error::operation_aborted
   * error code.
   *
   ...
   * error code xio::error::operation_aborted.
   *
   ...
   * @code void(xio::error_code, int) @endcode
   *
