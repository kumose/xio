...
#include <xio/detail/initiate_defer.h>
 ...
 */
    ...
    decltype(
        async_initiate<NullaryToken, void()>(
            std::declval<detail::initiate_defer>(), token)) {
 ...
 */
    ...
    inline auto defer(const Executor &ex,
        ...
        -> decltype(
            async_initiate<NullaryToken, void()>(
                std::declval<detail::initiate_defer_with_executor<Executor> >(),
 ...
 */
    ...
    decltype(
        async_initiate<NullaryToken, void()>(
            std::declval<detail::initiate_defer_with_executor<
                typename ExecutionContext::executor_type> >(),
            token, detail::empty_work_function())) {
        return async_initiate<NullaryToken, void()>(
