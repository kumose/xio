...
namespace xio {
    ...
    /**
 * @defgroup write_at xio::write_at
 *
 ...
 * @code xio::write_at(d, 42, xio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code xio::write_at(d, 42, xio::buffer(data, size),
 ...
 */
    ...
    /*@}*/
    /**
 * @defgroup async_write_at xio::async_write_at
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * xio::async_write_at(d, 42, xio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
