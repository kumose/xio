...
/// function with read_until and async_read_until.
    ...
    /**
 * @defgroup read_until xio::read_until
 *
 ...
 * @code typedef xio::buffers_iterator<
 *     xio::const_buffer> iterator;
 *
 ...
 * ...
 * std::string data;
 * xio::read_until(s, data, match_whitespace);
 * @endcode
 *
 ...
 *     : public boost::std::true_type {};
 * } // namespace xio
 * ...
 * std::string data;
 * xio::read_until(s, data, match_char('a'));
 * @endcode
 */
 ...
 * @code typedef xio::buffers_iterator<
 *     xio::streambuf::const_buffers_type> iterator;
 *
 * std::pair<iterator, bool>
 * match_whitespace(iterator begin, iterator end)
 * {
 ...
 * ...
 * xio::streambuf b;
 * xio::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * xio::streambuf b;
 * xio::read_until(s, b, match_char('a'));
 * @endcode
 */
 ...
 */
    ...
    /*@}*/
    /**
 * @defgroup async_read_until xio::async_read_until
 *
    ...
    inline auto async_read_until(AsyncReadStream &s,
        ...
        -> decltype(
            async_initiate<ReadToken,
                ...
                std::declval<detail::initiate_async_read_until_delim_v1<AsyncReadStream> >(),
 ...
 */
    ...
    inline auto async_read_until(AsyncReadStream &s,
        ...
        -> decltype(
            async_initiate<ReadToken,
                void(xio::error_code, std::size_t)>(
                std::declval<detail::initiate_async_read_until_delim_string_v1<
                    AsyncReadStream> >(),
 ...
 * ...
 * std::string data;
 * xio::async_read_until(s, data, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * xio::async_read_until(s, data, match_char('a'), handler);
 * @endcode
 *
 * @par Per-Operation Cancellation
 * This asynchronous operation supports cancellation for the following
 ...
 */
    ...
    inline auto async_read_until(AsyncReadStream &s,
        ...
        -> decltype(
            async_initiate<ReadToken,
                void(xio::error_code, std::size_t)>(
                std::declval<detail::initiate_async_read_until_match_v1<AsyncReadStream> >(),
                token, static_cast<DynamicBuffer_v1 &&>(buffers),
                match_condition)) {
        return async_initiate<ReadToken,
            void(xio::error_code, std::size_t)>(
 ...
 * ...
 * xio::streambuf b;
 * xio::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * xio::streambuf b;
 * xio::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 *
 * @par Per-Operation Cancellation
 * This asynchronous operation supports cancellation for the following
 ...
 */
    ...
    inline auto async_read_until(AsyncReadStream &s,
        ...
        -> decltype(
            async_initiate<ReadToken,
                void(xio::error_code, std::size_t)>(
                std::declval<detail::initiate_async_read_until_delim_v2<AsyncReadStream> >(),
 ...
 */
    ...
    inline auto async_read_until(AsyncReadStream &s, DynamicBuffer_v2 buffers,
        ...
        -> decltype(
            async_initiate<ReadToken,
                void(xio::error_code, std::size_t)>(
                std::declval<detail::initiate_async_read_until_delim_string_v2<
                    AsyncReadStream> >(),
 ...
 */
    ...
    inline auto async_read_until(AsyncReadStream &s,
        ...
        -> decltype(
            async_initiate<ReadToken,
                void(xio::error_code, std::size_t)>(
                std::declval<detail::initiate_async_read_until_match_v2<AsyncReadStream> >(),
