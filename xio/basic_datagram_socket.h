...
#ifndef XIO_BASIC_DATAGRAM_SOCKET_HPP
#define XIO_BASIC_DATAGRAM_SOCKET_HPP
 ...
 */
   ...
   */
        ...
        constraint_t<
            std::is_convertible<Protocol1, Protocol>::value
            && std::is_convertible<Executor1, Executor>::value,
            basic_datagram_socket &> operator=(basic_datagram_socket<Protocol1, Executor1> &&other) {
            basic_socket<Protocol, Executor>::operator=(std::move(other));
            return *this;
        }
   ...
   * @code socket.send(xio::buffer(data, size)); @endcode
   ...
   */
        ...
        std::size_t send(const ConstBufferSequence &buffers) {
            ...
            xio::detail::throw_error(ec, "send");
            return s;
        }
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(xio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
        ...
        auto async_send(const ConstBufferSequence &buffers,
            ...
            -> decltype(
                async_initiate<WriteToken,
                    ...
                    std::declval<initiate_async_send>(), token,
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * xio::ip::udp::endpoint destination(
   *     xio::ip::address::from_string("1.2.3.4"), 12345);
   * socket.send_to(xio::buffer(data, size), destination);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   */
        ...
        std::size_t send_to(const ConstBufferSequence &buffers,
            ...
            xio::detail::throw_error(ec, "send_to");
            return s;
        }
   ...
   *     xio::buffer(data, size), destination, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   */
        ...
        auto async_send_to(const ConstBufferSequence &buffers,
            ...
            -> decltype(
                async_initiate<WriteToken,
                    void(xio::error_code, std::size_t)>(
                    std::declval<initiate_async_send_to>(), token, buffers,
   ...
   */
        ...
        auto async_send_to(const ConstBufferSequence &buffers,
            ...
            -> decltype(
                async_initiate<WriteToken,
                    void(xio::error_code, std::size_t)>(
                    std::declval<initiate_async_send_to>(), token,
   ...
   * follows:
   * @code socket.receive(xio::buffer(data, size)); @endcode
   ...
   */
        ...
        std::size_t receive(const MutableBufferSequence &buffers) {
            ...
            std::size_t s = this->impl_.get_service().receive(
                this->impl_.get_implementation(), buffers, 0, ec);
            xio::detail::throw_error(ec, "receive");
            return s;
        }
   ...
   * follows:
   * @code
   * socket.async_receive(xio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   */
        ...
        auto async_receive(const MutableBufferSequence &buffers,
            ...
            -> decltype(
                async_initiate<ReadToken,
                    void(xio::error_code, std::size_t)>(
                    std::declval<initiate_async_receive>(), token, buffers, flags)) {
            return async_initiate<ReadToken,
                void(xio::error_code, std::size_t)>(
   ...
   * follows:
   * @code
   * xio::ip::udp::endpoint sender_endpoint;
   * socket.receive_from(
   *     xio::buffer(data, size), sender_endpoint);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   */
        ...
        std::size_t receive_from(const MutableBufferSequence &buffers,
            ...
            xio::detail::throw_error(ec, "receive_from");
            return s;
        }
   ...
   *     xio::buffer(data, size), sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   *
   ...
   */
        ...
        auto async_receive_from(const MutableBufferSequence &buffers,
            ...
            -> decltype(
                async_initiate<ReadToken,
                    void(xio::error_code, std::size_t)>(
                    std::declval<initiate_async_receive_from>(), token, buffers,
   ...
   */
        ...
        auto async_receive_from(const MutableBufferSequence &buffers,
            ...
            -> decltype(
                async_initiate<ReadToken,
                    void(xio::error_code, std::size_t)>(
                    std::declval<initiate_async_receive_from>(), token,
...
#endif // XIO_BASIC_DATAGRAM_SOCKET_HPP
