 ...
 * @code
 * xio::ip::tcp::acceptor acceptor(my_context);
 * xio::ip::tcp::endpoint endpoint(xio::ip::tcp::v4(), port);
 * acceptor.open(endpoint.protocol());
 * acceptor.set_option(xio::ip::tcp::acceptor::reuse_address(true));
 ...
 */
   ...
   */
        basic_socket_acceptor(const executor_type &ex,
            ...
            xio::detail::throw_error(ec, "listen");
        }
   ...
   * xio::ip::tcp::acceptor acceptor(my_context);
   * xio::error_code ec;
   * acceptor.open(xio::ip::tcp::v4(), ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * @code
   * xio::ip::tcp::acceptor acceptor(my_context);
   * xio::ip::tcp::endpoint endpoint(xio::ip::tcp::v4(), 12345);
   * acceptor.open(endpoint.protocol());
   * acceptor.bind(endpoint);
   * @endcode
   */
   ...
   * ...
   * xio::error_code ec;
   * acceptor.listen(xio::socket_base::max_listen_connections, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * xio::socket_base::enable_connection_aborted
   *
   * @par Example
   ...
   * xio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * xio::ip::tcp::acceptor::reuse_address option(true);
   ...
   * xio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * xio::ip::tcp::acceptor::reuse_address option;
   ...
   * xio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * xio::ip::tcp::acceptor::non_blocking_io command(true);
   ...
   * with xio::error::would_block if they are unable to perform the
   ...
   * xio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * xio::ip::tcp::endpoint endpoint = acceptor.local_endpoint();
   * @endcode
   */
   ...
   * ...
   * xio::error_code ec;
   * xio::ip::tcp::endpoint endpoint = acceptor.local_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * xio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * acceptor.wait(xio::ip::tcp::acceptor::wait_read);
   * @endcode
   */
   ...
   */
        ...
        void accept(basic_socket<Protocol1, Executor1> &peer,
            ...
            xio::detail::throw_error(ec, "accept");
        }
   ...
   * @par Example
   * @code
   * void accept_handler(const xio::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Accept succeeded.
   ...
   * xio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * xio::ip::tcp::socket socket(acceptor.accept());
   * @endcode
   */
   ...
   * xio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * xio::ip::tcp::socket socket(acceptor.accept(ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * xio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * xio::ip::tcp::socket socket(acceptor.accept(my_context2, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   */
        template<typename Executor1>
        typename Protocol::socket::template rebind_executor<Executor1>::other
        accept(const Executor1 &ex, xio::error_code &ec,
               constraint_t<
                   is_executor<Executor1>::value
                   || execution::is_executor<Executor1>::value
               > = 0) {
   ...
   */
        ...
        MoveAcceptToken= default_completion_token_t
        <
        executor_type
        >
        >
   ...
   * ...
   * xio::ip::tcp::endpoint endpoint;
   * xio::ip::tcp::socket socket(acceptor.accept(endpoint));
   * @endcode
   */
        typename Protocol::socket::template rebind_executor<executor_type>::other
   ...
   * ...
   * xio::ip::tcp::endpoint endpoint;
   * xio::ip::tcp::socket socket(acceptor.accept(endpoint, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   */
        typename Protocol::socket::template rebind_executor<executor_type>::other
        accept(endpoint_type &peer_endpoint, xio::error_code &ec) {
            typename Protocol::socket::template rebind_executor<
                executor_type>::other peer(impl_.get_executor());
            impl_.get_service().accept(impl_.get_implementation(),
                                       peer, &peer_endpoint, ec);
