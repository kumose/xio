 ...
 */
   ...
   */
        ...
        constraint_t<
            std::is_convertible<Protocol1, Protocol>::value
            && std::is_convertible<Executor1, Executor>::value,
            basic_stream_socket &> operator=(basic_stream_socket<Protocol1, Executor1> &&other) {
            basic_socket<Protocol, Executor>::operator=(std::move(other));
            return *this;
        }
   ...
   * @code
   * socket.send(xio::buffer(data, size));
   * @endcode
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.send(xio::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(xio::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.receive(xio::buffer(data, size));
   * @endcode
   ...
   * follows:
   * @code
   * socket.receive(xio::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(xio::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * @code
   * socket.write_some(xio::buffer(data, size));
   * @endcode
   ...
   */
        ...
        std::size_t write_some(const ConstBufferSequence &buffers) {
            ...
            std::size_t s = this->impl_.get_service().send(
                this->impl_.get_implementation(), buffers, 0, ec);
            xio::detail::throw_error(ec, "write_some");
            return s;
        }
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_write_some(xio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * @code
   * socket.read_some(xio::buffer(data, size));
   * @endcode
   ...
   */
        ...
        std::size_t read_some(const MutableBufferSequence &buffers) {
            ...
            std::size_t s = this->impl_.get_service().receive(
                this->impl_.get_implementation(), buffers, 0, ec);
            xio::detail::throw_error(ec, "read_some");
            return s;
        }
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_read_some(xio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
