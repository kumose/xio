...
#include <xio/detail/deadline_timer_service.h>
 ...
 *
 * Most applications will use the xio::deadline_timer typedef.
 *
 * @par Thread Safety
 ...
 * xio::deadline_timer timer(my_context);
 *
 ...
 * @code
 * void handler(const xio::error_code& error)
 * {
 *   if (!error)
 *   {
 *     // Timer expired.
 ...
 * }
 *
 * void on_timeout(const xio::error_code& e)
 * {
 *   if (e != xio::error::operation_aborted)
 *   {
 ...
 * @endcode
 *
 * @li The xio::basic_deadline_timer::expires_from_now() function
 * cancels any pending asynchronous waits, and returns the number of
 * asynchronous waits that were cancelled. If it returns 0 then you were too
 * late and the wait handler has already been executed, or will soon be
 * executed. If it returns 1 then the wait handler was successfully cancelled.
 *
 * @li If a wait handler is cancelled, the xio::error_code passed to
 ...
 */
   ...
   */
        ...
        explicit basic_deadline_timer (ExecutionContext
        &context,
                constraint_t<
   ...
   */
        ...
        impl_(0, ex)
        {
            ...
            xio::detail::throw_error(ec, "expires_at");
        }
   ...
   */
        ...
        impl_(0, ex)
        {
            ...
            xio::detail::throw_error(ec, "expires_from_now");
        }
   ...
   * be invoked with the xio::error::operation_aborted error code.
   *
   ...
   * error code that indicates the successful completion of the wait operation.
   */
        std::size_t cancel(xio::error_code &ec)
        {
   ...
   * xio::error::operation_aborted error code.
   *
   * Cancelling the timer does not change the expiry time.
   *
   ...
   */
        std::size_t cancel_one()
        {
            ...
            xio::detail::throw_error(ec, "cancel_one");
            return s;
        }
   ...
   * error code that indicates the successful completion of the wait operation.
   */
        std::size_t cancel_one(xio::error_code &ec)
        {
   ...
   * code xio::error::operation_aborted.
   *
