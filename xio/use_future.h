 ...
 * operation, typically using the special value @c xio::use_future. For
 * example:
 *
 * @code std::future<std::size_t> my_future
 *   = my_socket.async_read_some(my_buffer, xio::use_future); @endcode
 *
 ...
 */
   ...
   *     use_future([](xio::error_code ec, std::size_t n)
   *       {
   *         return ec ? 0 : n;
   *       }));
   * ...
