    ...
    namespace detail {
        ...
        struct co_spawn_state {
            ...
            co_spawn_state(H &&h, const Executor &ex, F &&f)
                : handler(std::forward<H>(h)),
                  spawn_work(ex),
                  handler_work(xio::get_associated_executor(handler, ex)),
        ...
        struct co_spawn_dispatch {
            ...
            auto operator()(CompletionToken &&token) const
                -> decltype(xio::dispatch(std::forward<CompletionToken>(token))) {
                return xio::dispatch(std::forward<CompletionToken>(token));
            }
        };
        ...
        struct co_spawn_post {
            template<typename CompletionToken>
            auto operator()(CompletionToken &&token) const
                -> decltype(xio::post(std::forward<CompletionToken>(token))) {
                return xio::post(std::forward<CompletionToken>(token));
            }
        };
        ...
        public:
            ...
            void operator()(cancellation_type_t type) {
                ...
                xio::dispatch(ex_, [sig, type] { sig->emit(type); });
            }
