...
namespace xio {
    ...
    namespace detail {
        ...
        inline typename Protocol::endpoint deref_connect_result(
            Iterator iter, xio::error_code &ec) {
    ...
    namespace detail {
        ...
        protected:
            ...
            void check_condition(const xio::error_code &ec,
        ...
        protected:
            ...
            template<typename Iterator>
            void check_condition(const xio::error_code &, Iterator &, Iterator &) {
            }
        };
        ...
        public:
            ...
            void operator()(xio::error_code ec, int start = 0) {
            ...
            //private:
            template<typename Iterator>
            void process(xio::error_code ec,
