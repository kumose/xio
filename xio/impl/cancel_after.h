...
#ifndef XIO_IMPL_CANCEL_AFTER_HPP
#define XIO_IMPL_CANCEL_AFTER_HPP
...
#include <xio/detail/timed_cancel_op.h>
    ...
    namespace detail {
        ...
        struct initiate_cancel_after : initiation_base<Initiation> {
            ...
            void operator()(Handler &&handler,
                ...
                typename op::ptr p = {
                    xio::detail::addressof(handler2.value),
        ...
        static auto initiate(Initiation &&initiation,
            ...
            -> decltype(
                async_initiate<
                    ...
                    Signatures...>(
                    std::declval<detail::initiate_cancel_after<
            ...
            -> decltype(
                async_initiate<
                    std::conditional_t<
                        ...
                        const CompletionToken, CompletionToken>,
                    Signatures...>(
                    std::declval<detail::initiate_cancel_after_timer<
...
#endif // XIO_IMPL_CANCEL_AFTER_HPP
