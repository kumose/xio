...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            ...
            redirect_error_handler(xio::error_code &ec,
                                   RedirectedHandler &&h)
                : ec_(ec),
            ...
            void operator()(const xio::error_code &ec, Args &&... args) {
                ec_ = ec;
        ...
        struct redirect_error_signature<R(xio::error_code, Args...)> {
            typedef R type(Args...);
        };

        template<typename R, typename... Args>
        struct redirect_error_signature<R(const xio::error_code &, Args...)> {
            typedef R type(Args...);
        };
        ...
        template<typename R, typename... Args>
        struct redirect_error_signature<
                    R(xio::error_code, Args...) noexcept> {
            typedef R type(Args...) & noexcept;
        };

        template<typename R, typename... Args>
        struct redirect_error_signature<
                    R(const xio::error_code &, Args...) noexcept> {
            typedef R type(Args...) & noexcept;
        };
