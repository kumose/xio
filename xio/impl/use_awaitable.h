...
#ifndef XIO_IMPL_USE_AWAITABLE_HPP
#define XIO_IMPL_USE_AWAITABLE_HPP
...
namespace xio {
    ...
    public:
        ...
        static handler_type *do_init(
            ...
            (void) u;
            XIO_HANDLER_LOCATION((u.file_name_, u.line_, u.function_name_));
...
#endif // XIO_IMPL_USE_AWAITABLE_HPP
