...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            ...
            void execute(F &&f) const {
                xio::require(system_executor(), Blocking()).execute(
        ...
        :
        public
        promise_handler_n<std::tuple<Arg0, ArgN...> > {
        };
    ...
    namespace traits {
        ...
        struct equality_comparable<
                    xio::detail::promise_executor<T, Blocking> > {
        ...
        struct execute_member<
                    xio::detail::promise_executor<T, Blocking>, Function> {
            static constexpr bool is_valid = true;
        ...
        struct require_member<
            ...
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
            typedef xio::detail::promise_executor<T,
