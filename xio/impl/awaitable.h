  ...
  ASIO_DECL bool is_launching();
        ...
        public:
            ...
            void operator delete(void *pointer, std::size_t size) {
                xio::detail::thread_info_base::deallocate(
                    xio::detail::thread_info_base::awaitable_frame_tag(),
                    xio::detail::thread_context::top_of_thread_call_stack(),
                    pointer, size);
            }
        ...
        public:
            ...
            static void resume(result_type &result) {
                if (*result != no_error) {
                    ...
                    xio::throw_exception(static_cast<Disposition &&>(d));
                }
            }
...
namespace std {
    ...
    struct coroutine_traits<xio::awaitable<T, Executor>, Args...> {
        typedef xio::detail::awaitable_frame<T, Executor> promise_type;
    };
} // namespace std
