...
#include <xio/detail/consuming_buffers.h>
#include <xio/detail/dependent_type.h>
...
namespace xio {
    ...
    namespace detail {
        ...
        std::size_t write_at_buffer_sequence(SyncRandomAccessWriteDevice &d,
                                             ...
                                             xio::error_code &ec) {
            ec = xio::error_code();
            xio::detail::consuming_buffers<const_buffer,
    ...
    std::size_t write_at(SyncRandomAccessWriteDevice &d,
        ...
        return detail::write_at_buffer_sequence(d, offset, buffers,
                                                xio::buffer_sequence_begin(buffers),
    ...
    inline std::size_t write_at(SyncRandomAccessWriteDevice &d,
        ...
        xio::detail::throw_error(ec, "write_at");
    ...
    template<typename SyncRandomAccessWriteDevice, typename Allocator,
        typename CompletionCondition>
    std::size_t write_at(SyncRandomAccessWriteDevice &d,
                         uint64_t offset, xio::basic_streambuf<Allocator> &b,
                         CompletionCondition completion_condition, xio::error_code &ec,
                         constraint_t<
                             is_completion_condition<CompletionCondition>::value
                         >) {
                ...
                switch (start_ = start) {
                    case 1:
                        ...
                        static_cast<WriteHandler &&>(handler_)(
                            static_cast<const xio::error_code &>(ec),
                            static_cast<const std::size_t &>(buffers_.total_consumed()));
                }
            }

            //private:
            typedef xio::detail::consuming_buffers<const_buffer,
    ...
    namespace detail {
        ...
        public:
            write_at_streambuf_op(
                xio::basic_streambuf<Allocator> &streambuf,
                WriteHandler &handler)
            ...
            //private:
            xio::basic_streambuf<Allocator> &streambuf_;
            WriteHandler handler_;
        };
