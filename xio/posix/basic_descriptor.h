...
constraint_t<
    is_convertible<Executor1, Executor>::value,
    basic_descriptor &> operator=(basic_descriptor<Executor1> &&other) {
...
/**
   ...
   * xio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   ...
   * ...
   * xio::posix::stream_descriptor::bytes_readable command;
...
/**
   ...
   * xio::posix::stream_descriptor descriptor(my_context);
   * ...
   * descriptor.wait(xio::posix::stream_descriptor::wait_read);
   * @endcode
   */
...
/**
   ...
   *     xio::posix::stream_descriptor::wait_read,
   *     wait_handler);
   * @endcode
   *
