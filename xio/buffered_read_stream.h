...
#ifndef XIO_BUFFERED_READ_STREAM_HPP
#define XIO_BUFFERED_READ_STREAM_HPP
...
#include <xio/detail/buffer_resize_guard.h>
#include <xio/detail/buffered_stream_storage.h>
 ...
 */
  ...
  /// buffer as a result of the operation, or 0 if an error occurred.
        std::size_t fill(xio::error_code &ec);
  ...
  /// or 0 if an error occurred.
        ...
        /// Determine the amount of data that may be read without blocking.
        std::size_t in_avail(xio::error_code &ec) {
            ec = xio::error_code();
            return storage_.size();
        }
  ...
  /// Returns the number of bytes copied.
        ...
        std::size_t copy(const MutableBufferSequence &buffers) {
            std::size_t bytes_copied = xio::buffer_copy(
  ...
  /// copied.
        ...
        std::size_t peek_copy(const MutableBufferSequence &buffers) {
            return xio::buffer_copy(buffers, storage_.data(), storage_.size());
        }
...
#include <xio/impl/buffered_read_stream.h>

#endif // XIO_BUFFERED_READ_STREAM_HPP
