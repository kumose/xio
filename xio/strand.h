...
#include <xio/detail/strand_executor_service.h>
...
namespace xio {
   ...
   *
   * For example:
   * @code xio::strand<my_executor_type> ex = ...;
   ...
   *
   * For example:
   * @code xio::strand<my_executor_type> ex1 = ...;
   ...
   */
    ...
    private:
        ...
        static implementation_type create_implementation(const InnerExecutor &ex,
            ...
            return use_service<detail::strand_executor_service>(
                xio::query(ex, execution::context)).create_implementation();
        }
    ...
    /** @defgroup make_strand xio::make_strand
 *
 * @brief The xio::make_strand function creates a @ref strand object for
