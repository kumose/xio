...
namespace xio {
   ...
   * @code xio::cancellation_type_t filter(
   *     xio::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *
   * @li xio::disable_cancellation
   * @li xio::enable_terminal_cancellation
   * @li xio::enable_partial_cancellation
   * @li xio::enable_total_cancellation
   */
   ...
   * cancellation signals as they are received from the parent slot. This
   * function object must have the signature:
   * @code xio::cancellation_type_t in_filter(
   *     xio::cancellation_type_t); @endcode
   *
   ...
   * @code xio::cancellation_type_t out_filter(
   *     xio::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *
