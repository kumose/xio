...
#ifndef XIO_BASIC_READABLE_PIPE_HPP
#define XIO_BASIC_READABLE_PIPE_HPP
...
constraint_t<
    std::is_convertible<Executor1, Executor>::value,
    basic_readable_pipe &> operator=(basic_readable_pipe<Executor1> &&other) {
...
/**
   ...
   * @code
   * basic_readable_pipe.read_some(xio::buffer(data, size));
   * @endcode
...
#endif // XIO_BASIC_READABLE_PIPE_HPP
