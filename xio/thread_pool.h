 ...
 *
 * To submit functions to the thread pool, use the @ref xio::dispatch,
 ...
 */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * xio::thread_pool& pool = xio::query(
   ...
   */
    ...
    namespace traits {
        ...
        struct equality_comparable<
                    xio::thread_pool::basic_executor_type<Allocator, Bits>
                > {
        ...
        struct require_member<
                ...
                > : xio::detail::thread_pool_bits {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
            typedef xio::thread_pool::basic_executor_type<
        ...
        struct require_member<
                    xio::thread_pool::basic_executor_type<Allocator, Bits>,
                    xio::execution::blocking_t::always_t
                > : xio::detail::thread_pool_bits {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = false;
            typedef xio::thread_pool::basic_executor_type<Allocator,
        ...
        struct query_static_constexpr_member<
            ...
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
            typedef xio::execution::inline_exception_handling_t::terminate_t
            result_type;
        ...
        struct query_member<
            ...
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
            typedef xio::thread_pool &result_type;
        };
