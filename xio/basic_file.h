...
/**
   ...
   * @par Example
   * @code
   * xio::stream_file file(my_context);
   * file.open("/path/to/my/file", xio::stream_file::read_only);
   * @endcode
   */
...
/**
   ...
   * xio::stream_file file(my_context);
   * xio::error_code ec;
   * file.open("/path/to/my/file", xio::stream_file::read_only, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
...
uint64_t size() const {
    ...
    xio::detail::throw_error(ec, "size");
    return s;
}
...
/**
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
uint64_t size(xio::error_code &ec) const {
...
void resize(uint64_t n) {
    ...
    xio::detail::throw_error(ec, "resize");
}
...
void sync_all() {
    ...
    xio::detail::throw_error(ec, "sync_all");
}
...
void sync_data() {
    ...
    xio::detail::throw_error(ec, "sync_data");
}
