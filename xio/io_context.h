 ...
 *
 * @li xio::ip::tcp::socket
 * @li xio::ip::tcp::acceptor
 * @li xio::ip::udp::socket
 * @li xio::deadline_timer.
 *
 ...
 *
 * To submit functions to the io_context, use the @ref xio::dispatch,
 * @ref xio::post or @ref xio::defer free functions.
 *
 * For example:
 *
 * @code void my_task()
 ...
 * xio::executor_work_guard<io_context::executor_type>:
 *
 * @code xio::io_context io_context;
 * xio::executor_work_guard<xio::io_context::executor_type>
 *   = xio::make_work_guard(io_context);
 * ... @endcode
 *
 ...
 */
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * if (xio::query(ex, xio::execution::outstanding_work)
   ...
   */
    ...
    namespace detail {
        ...
        class service_base
                : public xio::io_context::service {
        public:
            static xio::detail::service_id<Type> id;

            // Constructor.
            service_base(xio::io_context &io_context)
                : xio::io_context::service(io_context) {
            }
        };
    ...
    namespace traits {
        ...
        struct equality_comparable<
                    xio::io_context::basic_executor_type<Allocator, Bits>
                > {
        ...
        struct require_member<
                    xio::io_context::basic_executor_type<Allocator, Bits>,
                    xio::execution::blocking_t::possibly_t
                > {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = false;
            typedef xio::io_context::basic_executor_type<
        ...
        struct require_member<
                    xio::io_context::basic_executor_type<Allocator, Bits>,
                    xio::execution::blocking_t::never_t
                > {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = false;
            typedef xio::io_context::basic_executor_type<
        ...
        struct require_member<
                    xio::io_context::basic_executor_type<Allocator, Bits>,
                    xio::execution::relationship_t::fork_t
                > {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = false;
            typedef xio::io_context::basic_executor_type<
        ...
        struct require_member<
                    xio::io_context::basic_executor_type<Allocator, Bits>,
                    xio::execution::relationship_t::continuation_t
                > {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = false;
            typedef xio::io_context::basic_executor_type<
        ...
        struct require_member<
                    xio::io_context::basic_executor_type<Allocator, Bits>,
                    xio::execution::outstanding_work_t::tracked_t
                > : xio::detail::io_context_bits {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = false;
            typedef xio::io_context::basic_executor_type<
        ...
        struct require_member<
                    xio::io_context::basic_executor_type<Allocator, Bits>,
                    xio::execution::outstanding_work_t::untracked_t
                > : xio::detail::io_context_bits {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = false;
            typedef xio::io_context::basic_executor_type<
        ...
        struct require_member<
                    xio::io_context::basic_executor_type<Allocator, Bits>,
                    xio::execution::allocator_t<void>
                > {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = false;
            typedef xio::io_context::basic_executor_type<
        ...
        struct require_member<
                    xio::io_context::basic_executor_type<Allocator, Bits>,
                    xio::execution::allocator_t<OtherAllocator>
                > {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = false;
            typedef xio::io_context::basic_executor_type<
        ...
        struct query_static_constexpr_member<
                    ...
                    typename xio::enable_if<
                        xio::is_convertible<
                            Property,
                            xio::execution::outstanding_work_t
                        >::value
                    >::type
                > : xio::detail::io_context_bits {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
            typedef xio::execution::outstanding_work_t result_type;
        ...
        struct query_static_constexpr_member<
                    ...
                    typename xio::enable_if<
                        xio::is_convertible<
                            Property,
                            xio::execution::mapping_t
                        >::value
                    >::type
                > {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
            typedef xio::execution::mapping_t::thread_t result_type;
        ...
        struct query_static_constexpr_member<
                    ...
                    typename xio::enable_if<
                        xio::is_convertible<
                            Property,
                            xio::execution::inline_exception_handling_t
                        >::value
                    >::type
                > {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
            typedef xio::execution::inline_exception_handling_t::capture_t
            result_type;
        ...
        struct query_member<
            ...
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
            typedef xio::execution::blocking_t result_type;
        };
        ...
        struct query_member<
                    ...
                    typename xio::enable_if<
                        xio::is_convertible<
                            Property,
                            xio::execution::relationship_t
                        >::value
                    >::type
                > {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
            typedef xio::execution::relationship_t result_type;
        };

        template<typename Allocator, uintptr_t Bits>
        struct query_member<
                    xio::io_context::basic_executor_type<Allocator, Bits>,
                    xio::execution::context_t
                > {
            static constexpr bool is_valid = true;
            static constexpr bool is_noexcept = true;
            typedef xio::io_context &result_type;
        };
