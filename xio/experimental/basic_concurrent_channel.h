...
#ifndef XIO_EXPERIMENTAL_BASIC_CONCURRENT_CHANNEL_HPP
#define XIO_EXPERIMENTAL_BASIC_CONCURRENT_CHANNEL_HPP
...
#include <xio/experimental/detail/channel_send_functions.h>
#include <xio/experimental/detail/channel_service.h>
 ...
 */
        ...
        private:
            ...
            typedef detail::channel_service<xio::detail::mutex> service_type;
   ...
   */
            basic_concurrent_channel(const executor_type &ex,
                ...
                : service_(&xio::use_service<service_type>(
   ...
   * @c xio::experimental::error::channel_cancelled. Outstanding receive
        ...
        private:
            ...
            public:
                ...
                void operator()(SendHandler &&handler,
                    ...
                    xio::detail::non_const_lvalue<SendHandler> handler2(handler);
            ...
            public:
                ...
                void operator()(ReceiveHandler &&handler) const {
                    xio::detail::non_const_lvalue<ReceiveHandler> handler2(handler);
...
#endif // XIO_EXPERIMENTAL_BASIC_CONCURRENT_CHANNEL_HPP
