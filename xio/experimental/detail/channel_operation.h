...
#include <xio/detail/initiate_post.h>
#include <xio/detail/initiate_dispatch.h>
    ...
    namespace experimental {
        namespace detail {
            ...
            protected:
                ...
                friend class xio::detail::op_queue_access;
            ...
            public:
                ...
                void post(const IoExecutor &io_exec, Function &function, Handler &) {
                    (xio::detail::initiate_post_with_executor<IoExecutor>(io_exec))(
                        static_cast<Function &&>(function),
                        xio::detail::empty_work_function());
                }
            ...
            public:
                ...
                void post(const IoExecutor &, Function &function, Handler &handler) {
                    ...
                    xio::prefer(
                        xio::require(executor_, execution::blocking.never),
                        execution::allocator(allocator)
                    ).execute(static_cast<Function &&>(function));
                }
  ...
  executor_work_guard<Executor> work_;
            ...
            public:
                ...
                void immediate(Function &function, Handler &handler, ...) {
                    ...
                    (xio::detail::initiate_dispatch_with_executor<
        ...
        >::value
      >*) {
                    (xio::detail::initiate_post_with_executor<
                        typename base1_type::executor_type>(
