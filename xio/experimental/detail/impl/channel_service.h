...
#ifndef XIO_EXPERIMENTAL_DETAIL_IMPL_CHANNEL_SERVICE_HPP
#define XIO_EXPERIMENTAL_DETAIL_IMPL_CHANNEL_SERVICE_HPP
    ...
    namespace experimental {
        namespace detail {
            ...
            inline channel_service<Mutex>::channel_service(
                ...
                : xio::detail::execution_context_service_base<channel_service>(ctx),
                  mutex_(),
                  impl_list_(0) {
            }
            ...
            inline void channel_service<Mutex>::shutdown() {
                ...
                xio::detail::op_queue<channel_operation> ops;
            ...
            void channel_service<Mutex>::cancel_by_key(
                ...
                xio::detail::op_queue<channel_operation> other_ops;
                while (channel_operation *op = impl.waiters_.front()) {
...
#endif // XIO_EXPERIMENTAL_DETAIL_IMPL_CHANNEL_SERVICE_HPP
