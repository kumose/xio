...
#ifndef XIO_EXPERIMENTAL_DETAIL_CORO_COMPLETION_HANDLER_HPP
#define XIO_EXPERIMENTAL_DETAIL_CORO_COMPLETION_HANDLER_HPP
...
#endif // XIO_EXPERIMENTAL_DETAIL_CORO_COMPLETION_HANDLER_HPP
