...
#ifndef XIO_EXPERIMENTAL_DETAIL_CORO_PROMISE_ALLOCATOR_HPP
#define XIO_EXPERIMENTAL_DETAIL_CORO_PROMISE_ALLOCATOR_HPP
        ...
        namespace detail {
            ...
            void *allocate_coroutine(const std::size_t size, AllocatorType alloc_) {
                ...
                const auto align_offset = align_needed != 0
                                              ? alignof(alloc_type) - align_needed
                                              : 0ull;
...
#endif // XIO_EXPERIMENTAL_DETAIL_CORO_PROMISE_ALLOCATOR_HPP
