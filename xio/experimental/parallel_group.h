...
/// operations that can be used with with @c make_parallel_group.
  ...
  /// asynchronous operations.
        ...
        /**
 * See the documentation for xio::experimental::make_parallel_group for
 * a usage example.
 */
   ...
   * operations, it must return a xio::cancellation_type value other
   * than <tt>xio::cancellation_type::none</tt>.
   *
   ...
   *
   * @li xio::experimental::wait_for_all
   * @li xio::experimental::wait_for_one
   * @li xio::experimental::wait_for_one_error
   ...
   */
        ...
        /**
 * For example:
 * @code xio::experimental::make_parallel_group(
 ...
 *    [&](auto token)
 *    {
 *      return in.async_read_some(xio::buffer(data), token);
 *    },
 *    [&](auto token)
 *    {
 ...
 * @code
 * using op_type =
 *   decltype(socket1.async_read_some(xio::buffer(data1)));
 *
 * std::vector<op_type> ops;
 * ops.push_back(socket1.async_read_some(xio::buffer(data1)));
 * ops.push_back(socket2.async_read_some(xio::buffer(data2)));
 *
