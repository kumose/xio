...
//
#ifndef XIO_EXPERIMENTAL_IMPL_PROMISE_HPP
#define XIO_EXPERIMENTAL_IMPL_PROMISE_HPP
    ...
    namespace experimental {
        ...
        namespace detail {
            ...
            struct promise_impl<void(Ts...), Executor, Allocator> {
                ...
                typename xio::aligned_storage<sizeof(void *) * 4,
                ...
                template<typename... T_>
                void cancel_impl_(xio::error_code *, T_ *...) {
                    complete(xio::error::operation_aborted, T_{}...);
                }
...
#endif // XIO_EXPERIMENTAL_IMPL_PROMISE_HPP
