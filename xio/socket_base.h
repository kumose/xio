...
/// define the shutdown_type and enum.
   ...
   * ...
   * xio::socket_base::broadcast option(true);
   ...
   * xio::ip::udp::socket socket(my_context);
   * ...
   * xio::socket_base::broadcast option;
   ...
   * ...
   * xio::socket_base::debug option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * xio::ip::udp::socket socket(my_context);
   * ...
   * xio::socket_base::do_not_route option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * xio::ip::udp::socket socket(my_context);
   * ...
   * xio::socket_base::do_not_route option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::keep_alive option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::keep_alive option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::send_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::send_buffer_size option;
   * socket.get_option(option);
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::send_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::send_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::receive_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::receive_buffer_size option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::receive_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::receive_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ...
   * xio::socket_base::reuse_address option(true);
   ...
   * xio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * xio::socket_base::reuse_address option;
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::linger option(true, 30);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::out_of_band_inline option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::out_of_band_inline option;
   * socket.get_option(option);
   ...
   * operation is permitted to fail with xio::error::connection_aborted.
   ...
   * xio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * xio::socket_base::enable_connection_aborted option(true);
   * acceptor.set_option(option);
   * @endcode
   *
   * @par
   ...
   * xio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * xio::socket_base::enable_connection_aborted option;
   * acceptor.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::socket_base::bytes_readable command(true);
