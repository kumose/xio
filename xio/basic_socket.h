 ...
 */
   ...
   */
        basic_socket(const executor_type &ex, const protocol_type &protocol)
            ...
            xio::detail::throw_error(ec, "open");
        }
   ...
   */
        basic_socket(const executor_type &ex, const endpoint_type &endpoint)
            ...
            xio::detail::throw_error(ec, "bind");
        }
   ...
   */
        basic_socket(const executor_type &ex, const protocol_type &protocol,
            ...
            xio::detail::throw_error(ec, "assign");
        }
   ...
   */
        void close() {
            ...
            xio::detail::throw_error(ec, "close");
        }
  ...
  && (!defined(_WIN32_WINNT) || _WIN32_WINNT < 0x0603)
        ...
        native_handle_type release() {
            ...
            xio::detail::throw_error(ec, "release");
            return s;
        }
  ...
  && (!defined(_WIN32_WINNT) || _WIN32_WINNT < 0x0603)
        ...
        "prior to Windows 8.1."))
#endif
        native_handle_type release(xio::error_code &ec) {
  ...
  && !defined(ASIO_ENABLE_CANCELIO)
        ...
        void cancel() {
            ...
            xio::detail::throw_error(ec, "cancel");
        }
   ...
   */
        bool at_mark() const {
            ...
            xio::detail::throw_error(ec, "at_mark");
            return b;
        }
   ...
   * mark.
   */
        bool at_mark(xio::error_code &ec) const {
   ...
   */
        std::size_t available() const {
            ...
            std::size_t s = impl_.get_service().available(
                impl_.get_implementation(), ec);
            xio::detail::throw_error(ec, "available");
            return s;
        }
   ...
   * error occurs.
   */
        std::size_t available(xio::error_code &ec) const {
   ...
   * xio::ip::tcp::socket socket(my_context);
   * socket.open(xio::ip::tcp::v4());
   * socket.bind(xio::ip::tcp::endpoint(
   *       xio::ip::tcp::v4(), 12345));
   * @endcode
   */
   ...
   * @code
   * xio::ip::tcp::socket socket(my_context);
   * xio::ip::tcp::endpoint endpoint(
   *     xio::ip::address::from_string("1.2.3.4"), 12345);
   ...
   */
        void connect(const endpoint_type &peer_endpoint) {
            ...
            if (!is_open()) {
                ...
                xio::detail::throw_error(ec, "connect");
            }
   ...
   * @code void handler(
   *   const xio::error_code& error // Result of operation.
   * ); @endcode
   ...
   * @par Example
   * @code
   * void connect_handler(const xio::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Connect succeeded.
   ...
   * cancellation for the following xio::cancellation_type values:
   *
   ...
   */
        ...
        auto async_connect(const endpoint_type &peer_endpoint,
            ...
            return async_initiate<ConnectToken, void(xio::error_code)>(
   ...
   * xio::socket_base::do_not_route @n
   * xio::socket_base::keep_alive @n
   * xio::socket_base::linger @n
   * xio::socket_base::receive_buffer_size @n
   * xio::socket_base::receive_low_watermark @n
   * xio::socket_base::reuse_address @n
   * xio::socket_base::send_buffer_size @n
   * xio::socket_base::send_low_watermark @n
   * xio::ip::multicast::join_group @n
   * xio::ip::multicast::leave_group @n
   * xio::ip::multicast::enable_loopback @n
   * xio::ip::multicast::outbound_interface @n
   * xio::ip::multicast::hops @n
   * xio::ip::tcp::no_delay
   *
   * @par Example
   ...
   */
        ...
        void set_option(const SettableSocketOption &option) {
            ...
            xio::detail::throw_error(ec, "set_option");
        }
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::ip::tcp::socket::keep_alive option;
   ...
   */
        ...
        void get_option(GettableSocketOption &option) const {
            ...
            xio::detail::throw_error(ec, "get_option");
        }
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::ip::tcp::socket::bytes_readable command;
   ...
   */
        ...
        void io_control(IoControlCommand &command) {
            ...
            xio::detail::throw_error(ec, "io_control");
        }
   ...
   * xio::error::would_block if they are unable to perform the requested
   ...
   */
        void non_blocking(bool mode) {
            ...
            xio::detail::throw_error(ec, "non_blocking");
        }
   ...
   * direct system calls may fail with xio::error::would_block (or the
   ...
   *   void operator()(xio::error_code ec, std::size_t)
   *   {
   ...
   */
        void native_non_blocking(bool mode) {
            ...
            xio::detail::throw_error(ec, "native_non_blocking");
        }
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::ip::tcp::endpoint endpoint = socket.local_endpoint();
   * @endcode
   */
        endpoint_type local_endpoint() const {
            ...
            endpoint_type ep = impl_.get_service().local_endpoint(
                impl_.get_implementation(), ec);
            xio::detail::throw_error(ec, "local_endpoint");
            return ep;
        }
   ...
   * ...
   * xio::error_code ec;
   * xio::ip::tcp::endpoint endpoint = socket.local_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
        endpoint_type local_endpoint(xio::error_code &ec) const {
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * xio::ip::tcp::endpoint endpoint = socket.remote_endpoint();
   * @endcode
   */
        endpoint_type remote_endpoint() const {
            ...
            endpoint_type ep = impl_.get_service().remote_endpoint(
                impl_.get_implementation(), ec);
            xio::detail::throw_error(ec, "remote_endpoint");
            return ep;
        }
   ...
   * ...
   * xio::error_code ec;
   * xio::ip::tcp::endpoint endpoint = socket.remote_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
        endpoint_type remote_endpoint(xio::error_code &ec) const {
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * socket.shutdown(xio::ip::tcp::socket::shutdown_send);
   * @endcode
   */
        void shutdown(shutdown_type what) {
            xio::error_code ec;
            impl_.get_service().shutdown(impl_.get_implementation(), what, ec);
            xio::detail::throw_error(ec, "shutdown");
        }
   ...
   * ...
   * xio::error_code ec;
   * socket.shutdown(xio::ip::tcp::socket::shutdown_send, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * socket.wait(xio::ip::tcp::socket::wait_read);
   * @endcode
   */
        void wait(wait_type w) {
            xio::error_code ec;
            impl_.get_service().wait(impl_.get_implementation(), w, ec);
            xio::detail::throw_error(ec, "wait");
        }
   ...
   * @par Example
   * @code
   * void wait_handler(const xio::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Wait succeeded.
   ...
   * xio::ip::tcp::socket socket(my_context);
   * ...
   * socket.async_wait(xio::ip::tcp::socket::wait_read, wait_handler);
   * @endcode
   *
   * @par Per-Operation Cancellation
   * On POSIX or Windows operating systems, this asynchronous operation supports
