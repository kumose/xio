...
#include <xio/detail/io_uring_descriptor_read_at_op.h>
#include <xio/detail/io_uring_descriptor_read_op.h>
#include <xio/detail/io_uring_descriptor_write_at_op.h>
#include <xio/detail/io_uring_descriptor_write_op.h>
...
namespace xio {
  ...
  XIO_DECL native_handle_type release(implementation_type &impl);
            ...
            size_t write_some_at(implementation_type &impl, uint64_t,
                                 const null_buffers &buffers, xio::error_code &ec) {
