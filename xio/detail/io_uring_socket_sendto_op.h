...
#ifndef XIO_DETAIL_IO_URING_SOCKET_SENDTO_OP_HPP
#define XIO_DETAIL_IO_URING_SOCKET_SENDTO_OP_HPP
...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            io_uring_socket_sendto_op_base(const xio::error_code &success_ec,
        ...
        private:
            ...
            buffer_sequence_adapter<xio::const_buffer, ConstBufferSequence> bufs_;
            msghdr msghdr_;
        };
        ...
        public:
            XIO_DEFINE_HANDLER_PTR(io_uring_socket_sendto_op);

            io_uring_socket_sendto_op(const xio::error_code &success_ec,
...
#endif // XIO_DETAIL_IO_URING_SOCKET_SENDTO_OP_HPP
