...
#ifndef XIO_DETAIL_IO_URING_DESCRIPTOR_READ_OP_HPP
#define XIO_DETAIL_IO_URING_DESCRIPTOR_READ_OP_HPP
...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            io_uring_descriptor_read_op_base(const xio::error_code &success_ec,
        ...
        public:
            XIO_DEFINE_HANDLER_PTR(io_uring_descriptor_read_op);

            io_uring_descriptor_read_op(const xio::error_code &success_ec,
                                        int descriptor, descriptor_ops::state_type state,
...
#endif // XIO_DETAIL_IO_URING_DESCRIPTOR_READ_OP_HPP
