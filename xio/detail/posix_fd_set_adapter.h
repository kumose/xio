...
#ifndef XIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
#define XIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
            ...
            void set(reactor_op_queue<socket_type> &operations, op_queue<operation> &ops) {
                ...
                while (i != operations.end()) {
                    ...
                    if (!set(op_iter->first)) {
                        xio::error_code ec(error::fd_set_failure);
...
#endif // XIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
