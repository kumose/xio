...
#ifndef XIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
#define XIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
...
#include <xio/detail/socket_holder.h>
#include <xio/detail/socket_ops.h>
#include <xio/detail/socket_types.h>
#include <xio/detail/win_iocp_io_context.h>
#include <xio/detail/win_iocp_null_buffers_op.h>
#include <xio/detail/win_iocp_socket_connect_op.h>
#include <xio/detail/win_iocp_socket_send_op.h>
#include <xio/detail/win_iocp_socket_recv_op.h>
#include <xio/detail/win_iocp_socket_recvmsg_op.h>
#include <xio/detail/win_iocp_wait_op.h>
...
// Constructor.
XIO_DECL win_iocp_socket_service_base(execution_context & context);
...
void async_wait(base_implementation_type &impl,
    ...
    switch (w) {
        ...
        case socket_base::wait_error:
            ...
            break;
        default:
            p.p->ec_ = xio::error::invalid_argument;
...
size_t send(base_implementation_type &impl, const null_buffers &,
            socket_base::message_flags, xio::error_code &ec) {
...
size_t receive_with_flags(base_implementation_type &impl,
                          ...
                          socket_base::message_flags &out_flags, xio::error_code &ec) {
    buffer_sequence_adapter<xio::mutable_buffer,
        MutableBufferSequence> bufs(buffers);
...
// Helper function to restart an asynchronous accept operation.
  XIO_DECL void restart_accept_op(socket_type s,
...
XIO_DECL xio::error_code do_open(
    ...
    int protocol, xio::error_code &ec);

// Assign a native socket to a socket implementation.
XIO_DECL xio::error_code do_assign(
    base_implementation_type &impl, int type,
    socket_type native_socket, xio::error_code &ec);
...
// Helper function to start an asynchronous send_to operation.
  XIO_DECL void start_send_to_op(base_implementation_type &impl,
...
// Helper function to start an asynchronous null_buffers receive operation.
  XIO_DECL int start_null_buffers_receive_op(
...
// Helper function to start an asynchronous receive_from operation.
  XIO_DECL void start_receive_from_op(base_implementation_type &impl,
...
// Start an asynchronous read or write operation using the reactor.
  XIO_DECL void start_reactor_op(base_implementation_type &impl,
                                  int op_type, reactor_op *op);

// Start the asynchronous connect operation using the reactor.
  XIO_DECL int start_connect_op(base_implementation_type &impl,
...
// destroyed.
  XIO_DECL void close_for_destruction(base_implementation_type & impl);

// Update the ID of the thread from which cancellation is safe.
  XIO_DECL void update_cancellation_thread_id(
...
// cached in this service.
  XIO_DECL select_reactor &get_reactor();
...
// cached. Returns a null pointer if ConnectEx is not available.
  XIO_DECL connect_ex_fn get_connect_ex(
    base_implementation_type &impl, int type);
...
#endif // XIO_DETAIL_WIN_IOCP_SOCKET_SERVICE_BASE_HPP
