...
#include <xio/detail/win_iocp_overlapped_op.h>
...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            ...
            void complete(const xio::error_code &ec,
        ...
        private:
            ...
            static win_iocp_io_context *get_iocp_service(const Executor &ex,
                ...
                return &use_service<win_iocp_io_context>(
                    xio::query(ex, execution::context));
            }
            ...
            static win_iocp_io_context *get_iocp_service(
                ...
                return &xio::query(ex, execution::context).impl_;
            }
