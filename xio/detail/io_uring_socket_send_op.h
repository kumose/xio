...
#ifndef XIO_DETAIL_IO_URING_SOCKET_SEND_OP_HPP
#define XIO_DETAIL_IO_URING_SOCKET_SEND_OP_HPP
...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            io_uring_socket_send_op_base(const xio::error_code &success_ec,
        ...
        public:
            XIO_DEFINE_HANDLER_PTR(io_uring_socket_send_op);

            io_uring_socket_send_op(const xio::error_code &success_ec,
...
#endif // XIO_DETAIL_IO_URING_SOCKET_SEND_OP_HPP
