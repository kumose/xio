  ...
  ASIO_DECL static void init_native_buffer(
        ...
        public:
            ...
            explicit buffer_sequence_adapter(const Buffers &buffer_sequence)
                ...
                buffer_sequence_adapter::init(
                    xio::buffer_sequence_begin(buffer_sequence),
                    xio::buffer_sequence_end(buffer_sequence));
            }
            ...
            static Buffer linearise(const Buffers &buffer_sequence,
                                    const xio::mutable_buffer &storage) {
                return buffer_sequence_adapter::linearise(
                    xio::buffer_sequence_begin(buffer_sequence),
                    xio::buffer_sequence_end(buffer_sequence), storage);
            }
        ...
        private:
            ...
            static Buffer linearise(Iterator begin, Iterator end,
                                    const xio::mutable_buffer &storage) {
                xio::mutable_buffer unused_storage = storage;
                Iterator iter = begin;
                while (iter != end && unused_storage.size() != 0) {
                    ...
                    unused_storage += xio::buffer_copy(unused_storage, buffer);
                }
        ...
        class buffer_sequence_adapter<Buffer, xio::mutable_buffer>
                : buffer_sequence_adapter_base {
        public:
            ...
            explicit buffer_sequence_adapter(
                const xio::mutable_buffer &buffer_sequence) {
            ...
            static bool all_empty(const xio::mutable_buffer &buffer_sequence) {
                return buffer_sequence.size() == 0;
            }

            static void validate(const xio::mutable_buffer &buffer_sequence) {
                buffer_sequence.data();
            }

            static Buffer first(const xio::mutable_buffer &buffer_sequence) {
                return Buffer(buffer_sequence);
            }

            enum { linearisation_storage_size = 1 };

            static Buffer linearise(const xio::mutable_buffer &buffer_sequence,
                                    const Buffer &) {
                return Buffer(buffer_sequence);
            }
        ...
        template<typename Buffer>
        class buffer_sequence_adapter<Buffer, xio::const_buffer>
                : buffer_sequence_adapter_base {
        public:
            enum { is_single_buffer = true };
            ...
            explicit buffer_sequence_adapter(
                const xio::const_buffer &buffer_sequence) {
                init_native_buffer(buffer_, Buffer(buffer_sequence));
                total_buffer_size_ = buffer_sequence.size();
            }
            ...
            static bool all_empty(const xio::const_buffer &buffer_sequence) {
                return buffer_sequence.size() == 0;
            }

            static void validate(const xio::const_buffer &buffer_sequence) {
                buffer_sequence.data();
            }

            static Buffer first(const xio::const_buffer &buffer_sequence) {
                return Buffer(buffer_sequence);
            }

            enum { linearisation_storage_size = 1 };

            static Buffer linearise(const xio::const_buffer &buffer_sequence,
                                    const Buffer &) {
                return Buffer(buffer_sequence);
            }
        ...
        template<typename Buffer>
        class buffer_sequence_adapter<Buffer, xio::mutable_registered_buffer>
                : buffer_sequence_adapter_base {
        public:
            enum { is_single_buffer = true };
            ...
            explicit buffer_sequence_adapter(
                const xio::mutable_registered_buffer &buffer_sequence) {
        ...
        template<typename Buffer>
        class buffer_sequence_adapter<Buffer, xio::const_registered_buffer>
                : buffer_sequence_adapter_base {
        public:
            enum { is_single_buffer = true };
            ...
            explicit buffer_sequence_adapter(
                const xio::const_registered_buffer &buffer_sequence) {
                init_native_buffer(buffer_, buffer_sequence.buffer());
                total_buffer_size_ = buffer_sequence.size();
                registered_id_ = buffer_sequence.id();
            }
        ...
        public:
            ...
            static Buffer linearise(const boost::array<Elem, 2> &buffer_sequence,
                ...
                return Buffer(storage.data(),
                              xio::buffer_copy(storage, buffer_sequence));
            }
