...
#ifndef XIO_DETAIL_WIN_IOCP_SOCKET_RECV_OP_HPP
#define XIO_DETAIL_WIN_IOCP_SOCKET_RECV_OP_HPP
...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            XIO_DEFINE_HANDLER_PTR(win_iocp_socket_recv_op);
...
#endif // XIO_DETAIL_WIN_IOCP_SOCKET_RECV_OP_HPP
