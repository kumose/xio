...
#  if !defined(XIO_DISABLE_VISIBILITY)
#   pragma GCC visibility push (default)
#  endif // !defined(XIO_DISABLE_VISIBILITY)
...
#   if !defined(XIO_DISABLE_OBJC_WORKAROUND)
#    if !defined(Protocol) && !defined(id)
#     define Protocol cpp_Protocol
#     define id cpp_id
#     define XIO_OBJC_WORKAROUND
#    endif
#   endif
#  endif
# endif
...
# if defined(__MINGW32__) || defined(XIO_CYGWIN_W32_SOCKETS)
#  pragma pack (push, 8)
# endif
...
#  if !defined(XIO_DISABLE_CLR_WORKAROUND)
#   if !defined(generic)
#    define generic cpp_generic
#    define XIO_CLR_WORKAROUND
#   endif
#  endif
# endif
