...
#ifndef XIO_DETAIL_DESCRIPTOR_READ_OP_HPP
#define XIO_DETAIL_DESCRIPTOR_READ_OP_HPP
...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            descriptor_read_op_base(const xio::error_code &success_ec,
            ...
            static status do_perform(reactor_op *base) {
                ...
                XIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_read",
                                                o->ec_, o->bytes_transferred_));
        ...
        public:
            ...
            XIO_DEFINE_HANDLER_PTR(descriptor_read_op);

            descriptor_read_op(const xio::error_code &success_ec,
                               int descriptor, const MutableBufferSequence &buffers,
...
#endif // XIO_DETAIL_DESCRIPTOR_READ_OP_HPP
