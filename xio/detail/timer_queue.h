...
#ifndef XIO_DETAIL_TIMER_QUEUE_HPP
#define XIO_DETAIL_TIMER_QUEUE_HPP
...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            ...
            public:
                per_timer_data() : heap_index_((std::numeric_limits<std::size_t>::max)()),
                                   next_(0), prev_(0) {
                }
...
#endif // XIO_DETAIL_TIMER_QUEUE_HPP
