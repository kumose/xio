...
#ifndef XIO_DETAIL_WIN_IOCP_SOCKET_ACCEPT_OP_HPP
#define XIO_DETAIL_WIN_IOCP_SOCKET_ACCEPT_OP_HPP
...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            XIO_DEFINE_HANDLER_PTR(win_iocp_socket_accept_op);
            ...
            static void do_complete(void *owner, operation *base,
                ...
                if (owner) {
                    ...
                    if (ec == xio::error::connection_aborted
        ...
        public:
            XIO_DEFINE_HANDLER_PTR(win_iocp_socket_move_accept_op);
...
#endif // XIO_DETAIL_WIN_IOCP_SOCKET_ACCEPT_OP_HPP
