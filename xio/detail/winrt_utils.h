...
#ifndef XIO_DETAIL_WINRT_UTILS_HPP
#define XIO_DETAIL_WINRT_UTILS_HPP
    ...
    namespace detail {
        namespace winrt_utils {
            ...
            host_name(const T &from) {
                return ref
                new Windows::Networking::HostName((string)(from));
            }
            ...
            buffer_dup(
                ...
                byte *bytes = nullptr;
                bacc->Buffer(&bytes);
                xio::buffer_copy(xio::buffer(bytes, size), buffers);
                b->Length = size;
                return b;
            }
        } // namespace winrt_utils
...
#endif // XIO_DETAIL_WINRT_UTILS_HPP
