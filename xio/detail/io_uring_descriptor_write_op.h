...
#ifndef XIO_DETAIL_IO_URING_DESCRIPTOR_WRITE_OP_HPP
#define XIO_DETAIL_IO_URING_DESCRIPTOR_WRITE_OP_HPP
...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            io_uring_descriptor_write_op_base(const xio::error_code &success_ec,
        ...
        public:
            XIO_DEFINE_HANDLER_PTR(io_uring_descriptor_write_op);

            io_uring_descriptor_write_op(const xio::error_code &success_ec,
                                         int descriptor, descriptor_ops::state_type state,
                                         const ConstBufferSequence &buffers, Handler &handler,
                                         const IoExecutor &io_ex)
                : io_uring_descriptor_write_op_base<ConstBufferSequence>(success_ec,
                                                                         descriptor, state, buffers,
...
#endif // XIO_DETAIL_IO_URING_DESCRIPTOR_WRITE_OP_HPP
