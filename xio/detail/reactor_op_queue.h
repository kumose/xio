...
#ifndef XIO_DETAIL_REACTOR_OP_QUEUE_HPP
#define XIO_DETAIL_REACTOR_OP_QUEUE_HPP
    ...
    namespace detail {
        ...
        public:
            ...
            bool cancel_operations_by_key(iterator i, op_queue<operation> &ops,
                                          void *cancellation_key, const xio::error_code &ec =
                                                  xio::error::operation_aborted) {
                bool result = false;
                if (i != operations_.end()) {
...
#endif // XIO_DETAIL_REACTOR_OP_QUEUE_HPP
