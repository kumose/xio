...
#ifndef XIO_DETAIL_REACTIVE_SOCKET_RECV_OP_HPP
#define XIO_DETAIL_REACTIVE_SOCKET_RECV_OP_HPP
...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            reactive_socket_recv_op_base(const xio::error_code &success_ec,
            ...
            static status do_perform(reactor_op *base) {
                ...
                XIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_recv",
                                                o->ec_, o->bytes_transferred_));
        ...
        public:
            ...
            XIO_DEFINE_HANDLER_PTR(reactive_socket_recv_op);

            reactive_socket_recv_op(const xio::error_code &success_ec,
                                    socket_type socket, socket_ops::state_type state,
...
#endif // XIO_DETAIL_REACTIVE_SOCKET_RECV_OP_HPP
