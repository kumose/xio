...
#ifndef XIO_DETAIL_IO_URING_DESCRIPTOR_READ_AT_OP_HPP
#define XIO_DETAIL_IO_URING_DESCRIPTOR_READ_AT_OP_HPP
...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            XIO_DEFINE_HANDLER_PTR(io_uring_descriptor_read_at_op);

            io_uring_descriptor_read_at_op(const xio::error_code &success_ec,
...
#endif // XIO_DETAIL_IO_URING_DESCRIPTOR_READ_AT_OP_HPP
