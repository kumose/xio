...
#ifndef XIO_DETAIL_WIN_IOCP_HANDLE_WRITE_OP_HPP
#define XIO_DETAIL_WIN_IOCP_HANDLE_WRITE_OP_HPP
...
namespace xio {
    ...
    namespace detail {
        ...
        public:
            XIO_DEFINE_HANDLER_PTR(win_iocp_handle_write_op);
            ...
            static void do_complete(void *owner, operation *base,
                                    const xio::error_code &result_ec, std::size_t bytes_transferred) {
...
#endif // XIO_DETAIL_WIN_IOCP_HANDLE_WRITE_OP_HPP
