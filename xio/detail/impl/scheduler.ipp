...
namespace xio {
    ...
    namespace detail {
        ...
        scheduler::scheduler(xio::execution_context &ctx,
                             bool own_thread, get_task_func_type get_task)
            : xio::detail::execution_context_service_base<scheduler>(ctx),
        ...
        scheduler::scheduler(scheduler::internal, xio::execution_context &ctx)
            : xio::detail::execution_context_service_base<scheduler>(ctx),
              one_thread_(false),
        ...
        std::size_t scheduler::run(xio::error_code &ec) {
            ec = xio::error_code();
        ...
        std::size_t scheduler::run_one(xio::error_code &ec) {
            ec = xio::error_code();
            if (outstanding_work_ == 0) {
                stop();
                return 0;
        ...
        std::size_t scheduler::wait_one(long usec, xio::error_code &ec) {
            ec = xio::error_code();
            if (outstanding_work_ == 0) {
                stop();
                return 0;
        ...
        std::size_t scheduler::poll(xio::error_code &ec) {
            ec = xio::error_code();
            if (outstanding_work_ == 0) {
                stop();
                return 0;
        ...
        std::size_t scheduler::poll_one(xio::error_code &ec) {
            ec = xio::error_code();
            if (outstanding_work_ == 0) {
                stop();
                return 0;
