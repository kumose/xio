...
namespace xio {
    ...
    namespace detail {
        ...
        xio::error_code win_iocp_file_service::open(
        ...
        xio::error_code win_iocp_file_service::resize(
            win_iocp_file_service::implementation_type &impl,
        ...
        xio::error_code win_iocp_file_service::sync_all(
            win_iocp_file_service::implementation_type &impl,
            xio::error_code &ec) {
        ...
        xio::error_code win_iocp_file_service::sync_data(
            win_iocp_file_service::implementation_type &impl,
            xio::error_code &ec) {
