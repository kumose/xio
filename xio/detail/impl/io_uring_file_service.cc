...
namespace xio {
    ...
    namespace detail {
        ...
        xio::error_code io_uring_file_service::open(
        ...
        xio::error_code io_uring_file_service::resize(
            io_uring_file_service::implementation_type &impl,
        ...
        xio::error_code io_uring_file_service::sync_all(
            io_uring_file_service::implementation_type &impl,
            xio::error_code &ec) {
        ...
        xio::error_code io_uring_file_service::sync_data(
            io_uring_file_service::implementation_type &impl,
            xio::error_code &ec) {
