...
namespace xio {
    ...
    namespace detail {
        ...
        xio::error_code io_uring_socket_service_base::close(
            io_uring_socket_service_base::base_implementation_type &impl,
            xio::error_code &ec) {
            if (is_open(impl)) {
                ASIO_HANDLER_OPERATION((io_uring_service_.context(),
        ...
        xio::error_code io_uring_socket_service_base::cancel(
            io_uring_socket_service_base::base_implementation_type &impl,
            xio::error_code &ec) {
            if (!is_open(impl)) {
                ec = xio::error::bad_descriptor;
        ...
        xio::error_code io_uring_socket_service_base::do_open(
            io_uring_socket_service_base::base_implementation_type &impl,
            int af, int type, int protocol, xio::error_code &ec) {
            if (is_open(impl)) {
        ...
        xio::error_code io_uring_socket_service_base::do_assign(
