...
namespace xio {
    ...
    namespace detail {
        namespace descriptor_ops {
            int open(const char *path, int flags, xio::error_code &ec) {
            ...
            int open(const char *path, int flags,
                     unsigned mode, xio::error_code &ec) {
                int result = ::open(path, flags, mode);
                get_last_error(ec, result < 0);
                return result;
            }

            int close(int d, state_type &state, xio::error_code &ec) {
                int result = 0;
                if (d != -1) {
                    result = ::close(d);
                    get_last_error(ec, result < 0);
...
# endif // defined(ENOTCAPABLE)
            ...
            int fcntl(int d, int cmd, xio::error_code &ec) {
                if (d == -1) {
                    ec = xio::error::bad_descriptor;
                    return -1;
                }
            ...
            int fcntl(int d, int cmd, long arg, xio::error_code &ec) {
                if (d == -1) {
                    ec = xio::error::bad_descriptor;
                    return -1;
                }
            ...
            int poll_read(int d, state_type state, xio::error_code &ec) {
                if (d == -1) {
                    ec = xio::error::bad_descriptor;
                    return -1;
                }
            ...
            int poll_write(int d, state_type state, xio::error_code &ec) {
                if (d == -1) {
                    ec = xio::error::bad_descriptor;
                    return -1;
                }
            ...
            int poll_error(int d, state_type state, xio::error_code &ec) {
                if (d == -1) {
                    ec = xio::error::bad_descriptor;
                    return -1;
                }
