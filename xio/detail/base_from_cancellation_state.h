...
#ifndef XIO_DETAIL_BASE_FROM_CANCELLATION_STATE_HPP
#define XIO_DETAIL_BASE_FROM_CANCELLATION_STATE_HPP
    ...
    namespace detail {
        ...
        protected:
            ...
            base_from_cancellation_state(const Handler &handler, Filter filter)
                : cancellation_state_(
                    xio::get_associated_cancellation_slot(handler), filter, filter) {
            }
...
#endif // XIO_DETAIL_BASE_FROM_CANCELLATION_STATE_HPP
