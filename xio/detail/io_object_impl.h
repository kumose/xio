...
#ifndef XIO_DETAIL_IO_OBJECT_IMPL_HPP
#define XIO_DETAIL_IO_OBJECT_IMPL_HPP
    ...
    namespace detail {
        ...
        public:
            ...
            explicit io_object_impl(int, int, ExecutionContext &context)
                : service_(&xio::use_service<IoObjectService>(context)),
...
#endif // XIO_DETAIL_IO_OBJECT_IMPL_HPP
