...
#ifndef XIO_DETAIL_SIGNAL_SET_SERVICE_HPP
#define XIO_DETAIL_SIGNAL_SET_SERVICE_HPP
...
#include <xio/detail/signal_handler.h>
#include <xio/detail/signal_op.h>
...
#  include "xio/detail/io_uring_service.hpp"
...
namespace xio {
    ...
    namespace detail {
        ...
        extern XIO_DECL struct signal_state *get_signal_state();

        extern "C" XIO_DECL void XIO_VERSIONED_NAME(signal_handler)(
        ...
        public:
            ...
            // Constructor.
            XIO_DECL signal_set_service(execution_context &context);

            // Destructor.
            XIO_DECL ~signal_set_service();
  ...
  XIO_DECL void destroy(implementation_type &impl);
            ...
            XIO_DECL xio::error_code add(implementation_type &impl,
                                          int signal_number, signal_set_base::flags_t f,
                                          xio::error_code &ec);

            // Remove a signal to a signal_set.
            XIO_DECL xio::error_code remove(implementation_type &impl,
                                             int signal_number, xio::error_code &ec);

            // Remove all signals from a signal_set.
            XIO_DECL xio::error_code clear(implementation_type &impl,
                                            xio::error_code &ec);
  ...
  XIO_DECL void cancel_ops_by_key(implementation_type &impl,
  ...
  XIO_DECL static void deliver_signal(int signal_number);

        private:
            // Helper function to add a service to the global signal state.
  XIO_DECL static void add_service(signal_set_service *service);

            // Helper function to remove a service from the global signal state.
  XIO_DECL static void remove_service(signal_set_service *service);

            // Helper function to create the pipe descriptors.
  XIO_DECL static void open_descriptors();

            // Helper function to close the pipe descriptors.
  XIO_DECL static void close_descriptors();

            // Helper function to start a wait operation.
  XIO_DECL void start_wait_op(implementation_type &impl, signal_op *op);
...
#endif // XIO_DETAIL_SIGNAL_SET_SERVICE_HPP
