...
#include <xio/detail/timer_queue.h>
#include <xio/detail/timer_scheduler.h>
        ...
        public:
            ...
            deadline_timer_service(execution_context &context)
                : execution_context_service_base<
                  ...
                  scheduler_(xio::use_service<timer_scheduler>(context)) {
            ...
            std::size_t cancel(implementation_type &impl, xio::error_code &ec) {
                if (!impl.might_have_pending_waits) {
                    ec = xio::error_code();
                    return 0;
                }
            ...
            std::size_t expires_at(implementation_type &impl,
                                   const time_type &expiry_time, xio::error_code &ec) {
            ...
            std::size_t expires_after(implementation_type &impl,
                                      const duration_type &expiry_time, xio::error_code &ec) {
            ...
            void wait(implementation_type &impl, xio::error_code &ec) {
