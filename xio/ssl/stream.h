...
#include <xio/ssl/detail/buffered_handshake_op.h>
#include <xio/ssl/detail/handshake_op.h>
#include <xio/ssl/detail/io.h>
#include <xio/ssl/detail/read_op.h>
#include <xio/ssl/detail/shutdown_op.h>
#include <xio/ssl/detail/stream_core.h>
#include <xio/ssl/detail/write_op.h>
 ...
 * @code
 * xio::io_context my_context;
 * xio::ssl::context ctx(xio::ssl::context::sslv23);
 * xio::ssl::stream<xio::ip::tcp::socket> sock(my_context, ctx);
 * @endcode
 *
 * @par Concepts:
 ...
 */
   ...
   * @code
   * xio::ssl::stream<xio::ip::tcp::socket> sock(io_ctx, ctx);
   *
   ...
   */
            void handshake(handshake_type type) {
                xio::error_code ec;
                handshake(type, ec);
                xio::detail::throw_error(ec, "handshake");
            }
