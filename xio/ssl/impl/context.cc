...
namespace xio {
            ...
            switch (m) {
                ...
                case context::sslv2_server:
                    xio::detail::throw_error(
                        xio::error::invalid_argument, "context");
                    break;
    ...
    || defined(XIO_USE_WOLFSSL)
            ...
            if (handle_ == 0) {
                xio::error_code ec = translate_error(::ERR_get_error());
                xio::detail::throw_error(ec, "context");
            }
...
# endif // !defined(SSL_OP_NO_COMPRESSION)
        ...
        XIO_SYNC_OP_VOID context::set_options(
            ...
            handle_->comp_methods =
                    xio::ssl::detail::openssl_init<>::get_null_compression_methods();
#endif // (OPENSSL_VERSION_NUMBER >= 0x00908000L)
            o ^= context::no_compression;
            }
#endif // !defined(SSL_OP_NO_COMPRESSION)
    ...
    || defined(XIO_USE_WOLFSSL)
        ...
        void context::use_private_key_file(
            ...
            xio::detail::throw_error(ec, "use_private_key_file");
        }
    ...
    || defined(XIO_USE_WOLFSSL)
        ...
        xio::error_code context::translate_error(long error) {
#if (OPENSSL_VERSION_NUMBER >= 0x30000000L)
            ...
            return xio::error_code(static_cast<int>(error),
