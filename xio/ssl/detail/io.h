    ...
    namespace ssl {
        namespace detail {
            struct transfer_unlimited {
                std::size_t operator()(const xio::error_code &ec, std::size_t) const {
            ...
            std::size_t io(Stream &next_layer, stream_core &core,
                           const Operation &op, xio::error_code &ec) {
                xio::error_code io_ec;
            ...
            class io_op
                    : public xio::detail::base_from_cancellation_state<Handler> {
            public:
                io_op(Stream &next_layer, stream_core &core,
                      const Operation &op, Handler &handler)
                    : xio::detail::base_from_cancellation_state<Handler>(handler),
                ...
                io_op(const io_op &other)
                    : xio::detail::base_from_cancellation_state<Handler>(other),
                ...
                io_op(io_op &&other)
                    : xio::detail::base_from_cancellation_state<Handler>(
                          static_cast<
                              xio::detail::base_from_cancellation_state<Handler> &&>(other)),
                      next_layer_(other.next_layer_),
                      core_(other.core_),
                                ...
                                switch (want_ = op_(core_.engine_, ec_, bytes_transferred_)) {
                                    ...
                                    default:
                                        ...
                                        if (start) {
                                            ...
                                            next_layer_.async_read_some(
                                                xio::buffer(core_.input_buffer(), 0),
                                                static_cast<io_op &&>(*this));
                                ...
                                switch (want_) {
                                    case engine::want_input_and_retry:
                                        ...
                                        if (this->cancelled() != cancellation_type::none) {
                                            ec_ = xio::error::operation_aborted;
                                            break;
                                        }
