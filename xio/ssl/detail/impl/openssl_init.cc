...
namespace xio {
            ...
            public:
                do_init() {
                    ...
                    for (size_t i = 0; i < mutexes_.size(); ++i)
                        mutexes_[i].reset(new xio::detail::mutex);
  ...
  && (OPENSSL_VERSION_NUMBER >= 0x00908000L)
            ...
            private:
                ...
                std::vector<xio::detail::shared_ptr<
                    xio::detail::mutex> > mutexes_;
#endif // (OPENSSL_VERSION_NUMBER < 0x10100000L)
  ...
  && (OPENSSL_VERSION_NUMBER >= 0x00908000L)
            ...
            xio::detail::shared_ptr<openssl_init_base::do_init>
            openssl_init_base::instance() {
                static xio::detail::shared_ptr<do_init> init(new do_init);
                return init;
            }
