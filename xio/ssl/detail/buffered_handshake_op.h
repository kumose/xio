...
#ifndef XIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
#define XIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
        ...
        namespace detail {
            ...
            public:
                ...
                buffered_handshake_op(stream_base::handshake_type type,
                    ...
                    : type_(type),
                      buffers_(buffers),
                      total_buffer_size_(xio::buffer_size(buffers_)) {
                }
                ...
                engine::want operator()(engine &eng,
                    ...
                    return this->process(eng, ec, bytes_transferred,
                                         xio::buffer_sequence_begin(buffers_),
                                         xio::buffer_sequence_end(buffers_));
                }
...
#endif // XIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
