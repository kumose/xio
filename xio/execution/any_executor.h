...
#include <xio/detail/scoped_ptr.h>
#include <xio/detail/type_traits.h>
#include <xio/detail/throw_exception.h>
#include <xio/execution/bad_executor.h>
        ...
        namespace detail {
            ...
            public:
                ...
                shared_target_executor(const shared_target_executor &other) noexcept
                    : impl_(other.impl_) {
                    if (impl_)
                        xio::detail::ref_count_up(impl_->ref_count_);
                }
                ...
                ~shared_target_executor() {
                    if (impl_)
                        if (xio::detail::ref_count_down(impl_->ref_count_))
                            delete impl_;
                }
            ...
            private:
                ...
                struct impl_base {
                    ...
                    xio::detail::atomic_count ref_count_;
                };
                ...
                void execute(F &&f) const {
                    if (target_) {
                        if (target_fns_->blocking_execute != 0) {
                            xio::detail::non_const_lvalue<F> f2(f);
            ...
            protected:
                ...
                typedef xio::detail::executor_function function;
