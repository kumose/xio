 ...
 * @code xio::write(s, xio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code xio::write(s, xio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code xio::write(s, xio::buffer(data, size),
 ...
 */
    ...
    /*@}*/
    /**
 * @defgroup async_write xio::async_write
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * xio::async_write(s, xio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
