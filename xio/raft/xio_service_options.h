...
namespace xio::raft {
     ...
     */
    struct xio_service_meta_cb_params {
        xio_service_meta_cb_params(int m = 0,
                                   int s = 0,
                                   int d = 0,
                                   uint64_t t = 0,
                                   uint64_t lt = 0,
    ...
    struct xio_service_options {
         ...
         */
        std::function<std::string(const xio_service_meta_cb_params &)> write_req_meta_;

        /**
         * Callback function for reading and verifying Raft RPC request metadata.
         * If it returns `false`, the request will be discarded.
         */
        std::function<bool(const xio_service_meta_cb_params &,
         ...
         */
        std::function<std::string(const xio_service_meta_cb_params &)> write_resp_meta_;
        ...
        std::function<void(const std::string &,
                           const std::string &,
                           xio_service_custom_resolver_response)> custom_resolver_;
         ...
         */
        xio::io_context *custom_io_context_;
    };
}
