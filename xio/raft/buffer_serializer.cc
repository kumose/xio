...
namespace nuraft {
    ...
    void buffer_serializer::put_u16(uint16_t val) {
        chk_length(val);
        uint8_t *ptr = buf_.data_begin() + pos_;
        if (endian_ == LITTLE) { put16l(val, ptr); } else { put16b(val, ptr); }
        pos(pos() + sizeof(val));
    }
    ...
    void buffer_serializer::put_u32(uint32_t val) {
        chk_length(val);
        uint8_t *ptr = buf_.data_begin() + pos_;
        if (endian_ == LITTLE) { put32l(val, ptr); } else { put32b(val, ptr); }
        pos(pos() + sizeof(val));
    }
    ...
    void buffer_serializer::put_u64(uint64_t val) {
        chk_length(val);
        uint8_t *ptr = buf_.data_begin() + pos_;
        if (endian_ == LITTLE) { put64l(val, ptr); } else { put64b(val, ptr); }
        pos(pos() + sizeof(val));
    }
    ...
    uint16_t buffer_serializer::get_u16() {
        ...
        chk_length(ret);
        uint8_t *ptr = buf_.data_begin() + pos_;
        if (endian_ == LITTLE) { get16l(ptr, ret); } else { get16b(ptr, ret); }
        pos(pos() + sizeof(ret));
        return ret;
    }
    ...
    uint32_t buffer_serializer::get_u32() {
        ...
        chk_length(ret);
        uint8_t *ptr = buf_.data_begin() + pos_;
        if (endian_ == LITTLE) { get32l(ptr, ret); } else { get32b(ptr, ret); }
        pos(pos() + sizeof(ret));
        return ret;
    }
    ...
    uint64_t buffer_serializer::get_u64() {
        ...
        chk_length(ret);
        uint8_t *ptr = buf_.data_begin() + pos_;
        if (endian_ == LITTLE) { get64l(ptr, ret); } else { get64b(ptr, ret); }
        pos(pos() + sizeof(ret));
        return ret;
    }
