...
void send_break() {
    ...
    xio::detail::throw_error(ec, "send_break");
}
...
/**
   ...
   * xio::serial_port_base::flow_control @n
   * xio::serial_port_base::parity @n
   * xio::serial_port_base::stop_bits @n
...
/**
   ...
   * @code
   * basic_serial_port.write_some(xio::buffer(data, size));
   * @endcode
...
/**
   ...
   * @code
   * basic_serial_port.read_some(xio::buffer(data, size));
   * @endcode
