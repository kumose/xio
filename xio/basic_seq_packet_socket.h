...
#ifndef XIO_BASIC_SEQ_PACKET_SOCKET_HPP
#define XIO_BASIC_SEQ_PACKET_SOCKET_HPP
 ...
 */
   ...
   * follows:
   * @code
   * socket.receive(xio::buffer(data, size), out_flags);
   * @endcode
   ...
   * follows:
   * @code
   * socket.receive(xio::buffer(data, size), 0, out_flags);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(xio::buffer(data, size), out_flags, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
...
#endif // XIO_BASIC_SEQ_PACKET_SOCKET_HPP
