...
namespace xio {
    ...
    namespace generic {
        namespace detail {
            ...
            public:
                ...
                xio::detail::socket_addr_type *data() {
                    return &data_.base;
                }

                // Get the underlying endpoint in the native type.
                const xio::detail::socket_addr_type *data() const {
                    return &data_.base;
                }
  ...
  ASIO_DECL void resize(std::size_t size);
                ...
                std::size_t capacity() const {
                    return sizeof(xio::detail::sockaddr_storage_type);
                }
  ...
  ASIO_DECL friend bool operator<(
            ...
            private:
                ...
                union data_union {
                    ...
                    xio::detail::sockaddr_storage_type generic;
                } data_;
