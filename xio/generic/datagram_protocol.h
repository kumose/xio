...
#ifndef XIO_GENERIC_DATAGRAM_PROTOCOL_HPP
#define XIO_GENERIC_DATAGRAM_PROTOCOL_HPP
...
namespace xio {
    ...
    namespace generic {
        ...
        /**
 * The xio::generic::datagram_protocol class contains flags necessary
 ...
 * @code datagram_protocol p(xio::ip::udp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // XIO_GENERIC_DATAGRAM_PROTOCOL_HPP
