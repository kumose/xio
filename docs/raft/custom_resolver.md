...
You can attach your custom resolver that can be used when establishing new connections. When you set [`xio_options`](../include/libnuraft/xio_service_options.hxx), there is an option named `custom_resolver_`:
```C++
